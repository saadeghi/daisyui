...
- A megamenu can also contain plain links as direct children, like `<a>Documentation</a>`. They get the same style and the same moving indicator, and they do not need a popover.
