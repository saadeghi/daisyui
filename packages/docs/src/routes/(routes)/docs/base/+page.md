...
| `rootscrollock`   | Sets `:root` to `overflow: hidden` when modal or drawer is open                                                                  |
...
- [rootscrollock](https://github.com/saadeghi/daisyui/blob/master/packages/daisyui/src/base/rootscrollock.css)
