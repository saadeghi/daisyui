...
AI Tailwind generators are good at producing valid [utility classes](/tailwind-css/what-is-it-used-for/). The weak spot is consistency: the model can create three correct buttons with three different class recipes.
