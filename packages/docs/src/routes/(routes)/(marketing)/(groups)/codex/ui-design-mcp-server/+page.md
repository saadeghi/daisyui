...
A [UI design MCP server for Codex](/codex/use-less-tokens/) helps when your UI prompts keep repeating the same component guidance. Codex can inspect the repository, but it still needs reliable frontend context. Blueprint MCP supplies that context on demand.
