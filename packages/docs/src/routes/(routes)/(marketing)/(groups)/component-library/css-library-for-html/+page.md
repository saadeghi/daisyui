...
[Plain HTML](/tailwind-css/without-node/) can ship useful interfaces. The weak point is not HTML. It is repeating all the CSS needed for buttons, cards, forms, menus, alerts, and responsive states.
...
- [Forms](/component-library/easy/) need inputs, labels, validation states, selects, textareas, checkboxes, and radio buttons.
...
Tailwind CSS gives you utility classes for custom work. A [CSS component library](/component-library/easy-css-library/) gives names to repeated patterns.
