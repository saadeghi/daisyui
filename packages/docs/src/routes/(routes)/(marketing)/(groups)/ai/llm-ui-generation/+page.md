...
desc: LLM UI generation works better with semantic components instead of long Tailwind class strings.
...
[LLM UI generation](/ai/generate-ui-with-llm/) feels fast at the beginning. It slows down when the project accumulates verbose markup and every prompt has to carry more styling context than product context.
...
This is a scaling problem. As the UI grows, [component names](/tailwind-css/ui-components/) become cheaper to read than repeated utility recipes.
