...
<div role="tablist" class="tabs tabs-box">
  <input type="radio" name="my_tabs_1" autocomplete="off" class="tab" aria-label="Tab 1" />
  <input type="radio" name="my_tabs_1" autocomplete="off" class="tab" aria-label="Tab 2" checked="checked" />
  <input type="radio" name="my_tabs_1" autocomplete="off" class="tab" aria-label="Tab 3" />
</div>
...
<div class="tabs tabs-border w-full my-10 lg:mx-10">
  <input type="radio" name="my_tabs_2" autocomplete="off" class="tab" aria-label="Tab 1" />
  <div class="tab-content border-base-300 bg-base-100 p-10">Tab content 1</div>
  <input type="radio" name="my_tabs_2" autocomplete="off" class="tab" aria-label="Tab 2" checked="checked" />
  <div class="tab-content border-base-300 bg-base-100 p-10">Tab content 2</div>
  <input type="radio" name="my_tabs_2" autocomplete="off" class="tab" aria-label="Tab 3" />
...
<div class="tabs tabs-lift w-full my-10 lg:mx-10">
  <input type="radio" name="my_tabs_3" autocomplete="off" class="tab" aria-label="Tab 1" />
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 1</div>
  <input type="radio" name="my_tabs_3" autocomplete="off" class="tab" aria-label="Tab 2" checked="checked" />
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 2</div>
  <input type="radio" name="my_tabs_3" autocomplete="off" class="tab" aria-label="Tab 3" />
...
<div class="tabs tabs-lift w-full my-10 lg:mx-10">
  <label class="tab">
    <input type="radio" name="my_tabs_4" autocomplete="off" />
  ...
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 1</div>
  <label class="tab">
    <input type="radio" name="my_tabs_4" autocomplete="off" checked="checked" />
...
<div class="tabs tabs-bottom tabs-lift w-full my-10 lg:mx-10">
  <input type="radio" name="my_tabs_5" autocomplete="off" class="tab" aria-label="Tab 1" />
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 1</div>
  <input type="radio" name="my_tabs_5" autocomplete="off" class="tab" aria-label="Tab 2" checked="checked" />
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 2</div>
  <input type="radio" name="my_tabs_5" autocomplete="off" class="tab" aria-label="Tab 3" />
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 3</div>
</div>
...
<div class="tabs tabs-box w-full my-10 lg:mx-10">
  <input type="radio" name="my_tabs_6" autocomplete="off" class="tab" aria-label="Tab 1" />
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 1</div>
  <input type="radio" name="my_tabs_6" autocomplete="off" class="tab" aria-label="Tab 2" checked="checked" />
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 2</div>
  <input type="radio" name="my_tabs_6" autocomplete="off" class="tab" aria-label="Tab 3" />
  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 3</div>
</div>
...
<div class="overflow-x-auto max-w-60">
  <div class="tabs-lift tabs min-w-max">
    <input type="radio" name="my_tabs_7" autocomplete="off" class="tab z-1" aria-label="Tab title 1" />
    <div class="sticky start-0 tab-content max-w-60 border-base-300 bg-base-100 p-6">Tab content 1</div>
    <input type="radio" name="my_tabs_7" autocomplete="off" class="tab z-1" aria-label="Tab title 2" checked="checked" />
    <div class="sticky start-0 tab-content max-w-60 border-base-300 bg-base-100 p-6">Tab content 2</div>
    <input type="radio" name="my_tabs_7" autocomplete="off" class="tab z-1" aria-label="Tab title 3" />
    <div class="sticky start-0 tab-content max-w-60 border-base-300 bg-base-100 p-6">Tab content 3</div>
    <input type="radio" name="my_tabs_7" autocomplete="off" class="tab z-1" aria-label="Tab title 4" />
