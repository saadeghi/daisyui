  ...
  const codingTools = [
    {
      name: "Claude Code",
      slug: "claude-code",
      guideHref: "/blueprint/claudecode/",
      icon: "claude-code",
      agent: "claude-code",
    },
    {
    ...
    },
    {
      name: "Antigravity",
      slug: "antigravity",
      guideHref: "/blueprint/antigravity/",
      icon: "antigravity",
      agent: "antigravity",
    },
  ]
