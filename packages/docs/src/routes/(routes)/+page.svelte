...
<SEO
  title="daisyUI - Tailwind CSS Component Library"
  formatTitle={false}
  desc="Tailwind CSS component library by daisyUI. Build faster with semantic components, built-in themes, and reusable UI blocks."
/>
          ...
          <div>
            ...
            >
              ...
              <div class="[display:contents]">
                ...
                <div class="text-rotate text-base-content/70 text-xs leading-[2] duration-15000">
                    ...
                    <div class="justify-items-center">
                      <div>
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          fill="currentColor"
                          class="mb-1 inline-block size-4 text-yellow-500"
                        >
                          <path
                      ...
                      <div>
                        <svg
                          ...
                          viewBox="0 0 48 48"
                          fill="currentColor"
                          class="mb-1 inline-block size-4 text-red-500"
                        >
                          <path
                      ...
                      <div>
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          fill="currentColor"
                          class="mb-1 inline-block size-4 text-emerald-500"
                        >
                          <path
                    ...
                    {#if activeMenuItemOnHeroMockup === 3}
                      <div class="flex h-full flex-col px-4 py-4">
                        ...
                        <div class="join w-full">
                          ...
                          <button class="btn btn-neutral btn-sm join-item" aria-label="send">
                            <svg
                              fill="currentColor"
                              class="h-4 w-4"
                              viewBox="0 0 24 24"
            ...
            <label class="flex cursor-pointer items-center gap-3">
              ...
              <div class="relative">
                <input
                  ...
                  onchange={() => track("Homepage > UglyHtml > Toggle")}
                />
              </div>
              {$t("Tailwind + daisyUI")}
            </label>
