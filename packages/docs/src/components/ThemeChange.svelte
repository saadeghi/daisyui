...
<div title="Change Theme" class={`dropdown dropdown-end block ${dropdownClasses}`}>
  ...
  <div
    tabindex="0"
    class={`dropdown-content bg-base-200 text-base-content rounded-box top-px h-[28rem] max-h-[calc(100vh-10rem)] overflow-y-auto border border-white/5 shadow-2xl outline-1 outline-black/5 ${contentClasses}`}
  >
    <ul class="menu w-56">
