...
<div>
  <div
    class="flex h-[clamp(47rem,calc(100vh-4rem),90rem)] items-center justify-between"
    bind:this={hero1}>
    <div
      class="shrink-0 px-2 py-10 lg:pl-10 lg:pr-0"
...
<div
  ...
  <div
    ...
    style={`transform: rotateX(${animateValue(hero1, [60, 100], [20, 0])}deg)rotateZ(${animateValue(
      ...
      [50, 100],
      [-20, 0]
    )}deg)skewY(${animateValue(hero1, [60, 100], [8, 0])}deg)scale(${animateValue(
      hero2,
      [30, 40],
      [1, 0.8]
    )})`}
    ...
    <div class="grid">
      <!-- flying components -->
      <div
        class="z-[1] col-start-1 row-start-1 flex items-start"
        class:invisible={hero1 && scrollY > hero1.clientHeight}>
        <div class="w-60">
          <div
            ...
            style={`transform:translate(${animateValue(
              ...
              [35, 100],
              [0, 250]
            )}px,${animateValue(hero1, [35, 100], [0, -800])}px)`}>
            <div class="tabs">
              <button
                ...
                <div class="flex flex-col items-stretch py-8 px-6">
                  ...
                  <div class="form-control">
                    <label class="label cursor-pointer">
                      ...
                      <input type="checkbox" class="toggle toggle-sm toggle-secondary" checked />
                    </label>
                  </div>
                  <div class="form-control">
                    <label class="label cursor-pointer">
          ...
          <div class="flex flex-col gap-4 p-6">
            <div
              ...
              style={`transform:translate(${animateValue(
                ...
                [42, 100],
                [0, 250]
              )}px,${animateValue(hero1, [42, 100], [0, -800])}px)`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                fill="currentColor"
            ...
            <div
              ...
              style={`transform:translate(${animateValue(
                ...
                [50, 100],
                [0, 250]
              )}px,${animateValue(hero1, [50, 100], [0, -800])}px)`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                fill="currentColor"
        ...
        <div class="flex shrink-0 flex-col gap-6">
          <div
            ...
            style={`transform:translate(${animateValue(hero1, [0, 100], [0, 250])}px,${animateValue(
              hero1,
              [0, 100],
              [0, -800]
            )}px)`}>
          ...
          <div
            ...
            style={`transform:translate(${animateValue(
              ...
              [20, 100],
              [0, 250]
            )}px,${animateValue(hero1, [20, 100], [0, -800])}px)`}>
            <div class="card-body">
      ...
      <!-- code examples -->
      <div
        class="relative -top-6 col-start-1 row-start-1"
        class:invisible={hero1 && hero2 && scrollY > hero1.clientHeight + hero2.clientHeight}>
        <div>
          <div style={`opacity:${animateValue(hero2, [18, 23], [0, 100])}%`}>
            <div>
              <div class="tabs">
                <button class="tab tab-bordered w-24" />
                <button
                  on:click={() => (activeMenuItemOnCodeExample = 1)}
                  class:tab-active={activeMenuItemOnCodeExample === 1}
                  class="tab tab-bordered">
                  button.html
                </button>
                <button
                  on:click={() => (activeMenuItemOnCodeExample = 2)}
                  class:tab-active={activeMenuItemOnCodeExample === 2}
                  class="tab tab-bordered">
                  toggle.html
                </button>
                <button
                  on:click={() => (activeMenuItemOnCodeExample = 3)}
                  class:tab-active={activeMenuItemOnCodeExample === 3}
                  class="tab tab-bordered">
                  menu.html
                </button>
                <button class="tab tab-bordered grow" />
              </div>
            </div>
            {#if activeMenuItemOnCodeExample === 1}
              <div class="relative w-[590px]">
                <pre class="h-[28.5rem] overflow-x-scroll px-10"><code class="whitespace-pre-wrap">
<span class="text-base-content/40 italic">// you need to write this many class names</span>
<span class="text-base-content/40 italic">// to make a simple button?</span>

&lt;button class=&quot;<span
                      class="text-amber-600">inline-block cursor-pointer rounded-md bg-indigo-600 px-4 py-3 text-center text-sm font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:ring-offset-2 active:scale-95</span>&quot;&gt;
  Simple button
&lt;/button&gt;</code></pre>
                <div
                  class="mockup mockup-window border-base-300 bg-base-100 relative -left-20 bottom-32 w-64 justify-center border shadow-2xl"
                  style={`transform:scale(${animateValue(
                    ...
                    [22, 23],
                    [0, -5]
                  )}px); opacity:${animateValue(hero2, [22, 23], [0, 100])}%`}>
                  <div class="p-6 pt-2">
                    <button
                      class="inline-block cursor-pointer rounded-md bg-indigo-600 px-4 py-3 text-center text-sm font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:ring-offset-2 active:scale-95">
                      Simple button
                    </button>
                  </div>
                </div>
            ...
            {/if}
            {#if activeMenuItemOnCodeExample === 2}
              <div class="relative w-[590px]">
                <pre class="h-[28.5rem] overflow-x-scroll px-10"><code class="whitespace-pre">
<span class="text-base-content/40 italic">// Do you have to do these CSS tricks</span>
<span class="text-base-content/40 italic">// to make a standard toggle ...again?</span>

&lt;div class=&quot;<span class="text-amber-600">relative inline-block</span>&quot;&gt;&#10;
  &lt;input type=&quot;checkbox&quot; class=&quot;<span
                      class="text-amber-600">peer h-6 w-12 cursor-pointer appearance-none rounded-full border border-gray-300 checked:border-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2</span>&quot; /&gt;&#10;
  &lt;span class=&quot;<span
                      class="text-amber-600">pointer-events-none absolute left-1 top-1 block h-4 w-4 rounded-full bg-gray-300 transition-all duration-200 peer-checked:left-7 peer-checked:bg-gray-900</span>&quot;&gt;&lt;/span&gt;
&lt;/div&gt;</code></pre>
                <div
                  class="mockup mockup-window border-base-300 bg-base-100 relative -left-20 bottom-52 w-64 justify-center border shadow-2xl"
                  style={`transform:scale(${animateValue(
                    hero2,
                    [22, 23],
                    [0.95, 1]
                  ...
                  <div class="p-6 pt-2">
                    <div class="relative inline-block">
                      <input
                        type="checkbox"
                        class="peer h-6 w-12 cursor-pointer appearance-none rounded-full border border-gray-300 checked:border-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2" />
                      <span
                        class="pointer-events-none absolute left-1 top-1 block h-4 w-4 rounded-full bg-gray-300 transition-all duration-200 peer-checked:left-7 peer-checked:bg-gray-900" />
                    </div>
                  </div>
                </div>
              </div>
            {/if}
            {#if activeMenuItemOnCodeExample === 3}
              <div class="relative w-[590px]">
                <pre class="h-[28.5rem] overflow-x-scroll px-10"><code class="whitespace-pre">
&lt;ul class=&quot;<span class="text-amber-600">rounded-xl bg-gray-100 p-2</span>&quot;&gt;&#10;
  &lt;li class=&quot;<span
                      class="text-amber-600">block px-5 py-2 text-sm font-bold text-gray-400</span>&quot;&gt;Menu Title&lt;/li&gt;&#10;
  &lt;li&gt;&lt;button class=&quot;<span
                      class="text-amber-600">block w-full cursor-pointer rounded-lg px-5 py-2 text-start text-sm text-gray-900 outline-none hover:bg-gray-200 active:bg-gray-700 active:text-white</span>&quot;&gt;
    First Menu Item
  &lt;/button&gt;&lt;/li&gt;&#10;
  &lt;li&gt;&lt;button class=&quot;<span
                      class="text-amber-600">block w-full cursor-pointer rounded-lg px-5 py-2 text-start text-sm text-gray-900 outline-none hover:bg-gray-200 active:bg-gray-700 active:text-white</span>&quot;&gt;
...
&lt;/ul&gt;</code></pre>
                <div
                  ...
                  <div class="p-6 pt-2">
                    <ul class="rounded-xl bg-gray-100 p-2">
                      <li class="block px-5 py-2 text-sm font-bold text-gray-400">Menu Title</li>
                      <li>
                        <button
                          class="block w-full cursor-pointer rounded-lg px-5 py-2 text-start text-sm text-gray-900 outline-none hover:bg-gray-200 active:bg-gray-700 active:text-white">
                          First Menu Item
                        </button>
                      </li>
                      <li>
...
<div bind:this={hero2}>
  ...
  <div>
    <div class="max-w-[50vw] px-2 py-10 lg:px-10">
      <h2 class="font-title text-7xl font-light leading-none">
        <span>
          You're spending so much time to write a large amount of class&nbsp;names for each element
        </span>
      </h2>
      <div class="h-4" />
      <p class="text-base-content/60 font-title py-4 text-2xl font-light">
        But most elements need the the same common styles.
        <br />
        And with Tailwind CSS you have to write them over and over again.
        <br />
        For every element,
        <br />
        <span class="block pl-24">every theme,</span>
        <span class="block pl-40">every page</span>
        <span class="block pl-64">and every project ಠ_ಠ</span>
      </p>
    </div>
  </div>
    ...
    <div class="w-full py-40 px-2 lg:px-10">
      ...
      <div class="flex items-center gap-6">
        {#if toggleValueForCodeCompare}
          <div
            class="mockup-code border-base-content/10 text-base-content relative h-[480px] max-w-[calc(70vw-5rem)] grow border bg-transparent text-sm">
            <pre class="px-6"><code class="overflow-x-auto" />&lt;div class=&quot;<span
  ...
  &lt;/div&gt;</pre>
    ...
    &lt;div class=&quot;<span class="text-amber-600">flex flex-col gap-2 p-8</span>&quot;&gt;
      &lt;input placeholder=&quot;Email&quot; class=&quot;<span
                class="text-amber-600">w-full rounded-lg border border-gray-300 bg-white px-4 py-3 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-offset-2 focus:ring-offset-gray-100</span>&quot; /&gt;
      &lt;label class=&quot;<span
          ...
          <div>
            <div class="w-80 rounded-2xl bg-gray-100">
              <div class="flex flex-col gap-2 p-8">
                <input
                  placeholder="Email"
                  class="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-offset-2 focus:ring-offset-gray-100" />
