...
<div class="flex grow flex-col gap-6">
  ...
  <div
    class="rounded-box flex grow flex-col px-6 pb-8 pt-12 text-center motion-reduce:!transform-none max-[1280px]:!transform-none"
...
<div
  ...
  <div class="card-body">
    ...
    <div class="grid grid-cols-4 gap-4">
      ...
      <div class="flex flex-col items-center gap-1">
        <div class="bg-info-content rounded-btn aspect-square w-10" />
        <div class="text-base-content/60 text-center text-[.6rem]">info content</div>
      </div>
      <div class="flex flex-col items-center gap-1">
        <div class="bg-success-content rounded-btn aspect-square w-10" />
        <div class="text-base-content/60 text-center text-[.6rem]">success content</div>
      </div>
      <div class="flex flex-col items-center gap-1">
        <div class="bg-warning-content rounded-btn aspect-square w-10" />
        <div class="text-base-content/60 text-center text-[.6rem]">warning content</div>
      </div>
      <div class="flex flex-col items-center gap-1">
        <div class="bg-error-content rounded-btn aspect-square w-10" />
