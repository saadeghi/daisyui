  ...
  <div class="px-2 pt-2">
    <div class="navbar text-primary-content rounded-box space-x-1">
      <div class="hidden flex-none md:flex">
        <div class="dropdown">
          <div tabindex="0">
            <button aria-label="drawer component" class="btn btn-ghost mask mask-squircle btn-square focus:bg-base-content border-none focus:bg-opacity-50"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block h-6 w-6 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" /></svg></button>
          </div>
          <div tabindex="0" class="dropdown-content py-2">
            <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
              <div class="card-body">
                ...
                <p class="text-neutral-content text-sm text-opacity-80">Drawer component is useful for opening a sidebar menu</p>
      ...
      <div class="hidden flex-1 md:flex md:flex-none">
        <div class="form-control">
          <div class="dropdown">
            <div tabindex="0"><input placeholder="Text Input" class="input input-ghost input-bordered text-primary-content placeholder-primary-content focus:text-primary-content rounded-full focus:bg-transparent" /></div>
            <div tabindex="0" class="dropdown-content py-2">
              <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
                <div class="card-body">
      ...
      <div class="dropdown dropdown-left">
        <div tabindex="0">
          <button aria-label="navbar component" class="btn btn-ghost mask mask-squircle btn-square focus:bg-base-content hidden border-none focus:bg-opacity-50 md:flex"><div class="avatar"><div class="mask mask-squircle h-10 w-10"><img src="/tailwind-css-component-profile-1@40w.png" alt="Avatar Tailwind CSS Component" /></div></div></button>
        </div>
        <div tabindex="0" class="dropdown-content py-2">
          <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
            <div class="card-body">
              <h2 class="card-title font-extrabold capitalize">avatar component</h2>
              <p class="text-neutral-content text-sm text-opacity-80">Use avatar component with any size</p>
  ...
  <div id="component-demo" class="flex w-full grid-flow-row grid-cols-12 items-center gap-4 overflow-y-hidden overflow-x-scroll px-10 pt-1 pb-10 xl:grid xl:overflow-x-auto xl:px-4">
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
              <div class="card-body">
                ...
                <p class="text-neutral-content text-sm text-opacity-80">Card component is used to show products, features and more.</p>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
              <div class="card-body">
                ...
                <p class="text-neutral-content text-sm text-opacity-80">Use badge component to highlight small inline items</p>
        ...
        <div tabindex="0" class="dropdown-content py-2">
          <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
            <div class="card-body">
              ...
              <p class="text-neutral-content text-sm text-opacity-80">Use it to group multiple buttons together</p>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
              <div class="card-body">
                ...
                <p class="text-neutral-content text-sm text-opacity-80">Buttons come in various shapes, colors and sizes</p>
    ...
    <div class="card bg-base-100 col-span-3 row-span-4 mx-2 w-72 flex-shrink-0 overflow-visible shadow-xl xl:mx-0 xl:w-auto">
      ...
      <div class="card-body">
            ...
            <div tabindex="0" class="dropdown-content py-2">
              <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
                <div class="card-body">
                  ...
                  <p class="text-neutral-content text-sm text-opacity-80">helper dropdown can show an element when focused.</p>
        ...
        <p class="text-base-content text-sm text-opacity-80">Use card component to easily show blog posts, products, features, items and more.</p>
    ...
    <div class="col-span-3 row-span-3 mx-2 flex w-72 flex-shrink-0 flex-col place-self-start xl:mx-0 xl:w-full">
      <div class="dropdown">
        <div tabindex="0" class="bg-opacity-100">
          <div class="tabs w-full flex-grow-0">
            <button class="tab tab-lifted tab-active tab-border-none tab-lg flex-1">Stats</button>
            <button class="tab tab-lifted tab-border-none tab-lg flex-1">Info</button>
            <button class="tab tab-lifted tab-border-none tab-lg flex-1">Options</button>
          </div>
        </div>
        <div tabindex="0" class="dropdown-content py-2">
          <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
            <div class="card-body">
              ...
              <p class="text-neutral-content text-sm text-opacity-80">Beautiful tabs to switch between sections</p>
      ...
      <div class="bg-base-100 grid w-full flex-grow gap-3 rounded-xl rounded-tl-none p-6 shadow-xl">
        <div class="flex items-center space-x-2">
          <div class="dropdown">
            <div tabindex="0"><div class="online avatar"><div class="mask mask-hexagon bg-base-content h-16 w-16 bg-opacity-10 p-px"><img src="/tailwind-css-component-profile-5@56w.png" alt="Avatar Tailwind CSS Component" class="mask mask-hexagon" /></div></div></div>
            <div tabindex="0" class="dropdown-content py-2">
              <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
                <div class="card-body">
                  <h2 class="card-title font-extrabold capitalize">avatar component</h2>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
              <div class="card-body">
                ...
                <p class="text-neutral-content text-sm text-opacity-80">User divider component to visually separate items</p>
            ...
            <div tabindex="0" class="dropdown-content py-2">
              <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
                <div class="card-body">
                  ...
                  <p class="text-neutral-content text-sm text-opacity-80">Show progressbar, loadings or simple bar charts using progress component</p>
      ...
      <div class="dropdown dropdown-end w-full">
        <div tabindex="0">
          <div class="flex items-center justify-between">
            <div class="online avatar"><div class="mask mask-squircle bg-base-100 h-16 w-16 p-1"><img src="/tailwind-css-component-profile-3@56w.png" alt="Avatar Tailwind CSS Component" class="mask mask-squircle" /></div></div>
            <div class="online avatar"><div class="mask mask-squircle bg-base-100 h-16 w-16 p-1"><img src="/tailwind-css-component-profile-2@56w.png" alt="Avatar Tailwind CSS Component" class="mask mask-squircle" /></div></div>
            <div class="avatar offline"><div class="mask mask-squircle bg-base-100 h-16 w-16 p-1"><img src="/tailwind-css-component-profile-4@56w.png" alt="Avatar Tailwind CSS Component" class="mask mask-squircle" /></div></div>
            <div class="avatar"><div class="mask mask-squircle bg-base-100 h-16 w-16 p-1"><img src="/tailwind-css-component-profile-5@56w.png" alt="Avatar Tailwind CSS Component" class="mask mask-squircle" /></div></div>
          </div>
        </div>
        <div tabindex="0" class="dropdown-content py-2">
          <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
    ...
    <div class="bg-base-100 text-base-content rounded-box col-span-3 row-span-4 mx-2 grid w-72 flex-shrink-0 shadow-xl xl:mx-0 xl:w-auto xl:place-self-stretch">
        ...
        <div tabindex="0" class="dropdown-content py-2">
          <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
            <div class="card-body">
              ...
              <p class="text-neutral-content text-sm text-opacity-80">Pagination buttons in many colors and sizes!</p>
      ...
      <div class="dropdown dropdown-end dropdown-top">
        ...
        <div tabindex="0" class="dropdown-content py-2">
          <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
            <div class="card-body">
              <h2 class="card-title font-extrabold capitalize">tab component</h2>
              <p class="text-neutral-content text-sm text-opacity-80">Tab component with several sizes and styles</p>
              <div class="mt-4 flex justify-end"><a href="/components/tab" class="btn btn-primary btn-sm xl:btn-md">See component</a></div>
            </div>
          </div>
        </div>
    ...
    <div class="bg-base-100 text-base-content rounded-box col-span-3 row-span-3 mx-2 grid w-72 flex-shrink-0 items-stretch shadow-xl xl:mx-0 xl:w-auto xl:place-self-stretch">
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
              <div class="card-body">
                ...
                <p class="text-neutral-content text-sm text-opacity-80">Show alerts, warnings, notification or other info</p>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
              <div class="card-body">
                ...
                <p class="text-neutral-content text-sm text-opacity-80">Use it for sidebar or any other list of items</p>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
              <div class="card-body">
                ...
                <p class="text-neutral-content text-sm text-opacity-80">Make a better navigation with breadcrumbs!</p>
    ...
    <div class="card bg-base-100 col-span-3 row-span-1 mx-2 w-72 flex-shrink-0 overflow-visible shadow-lg xl:mx-0 xl:w-auto xl:place-self-stretch">
              ...
              <div tabindex="0" class="dropdown-content py-2">
                <div class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
                  <div class="card-body">
                    ...
                    <p class="text-neutral-content text-sm text-opacity-80">Buttons can get loadings state using a simple class</p>
                    <div class="mt-4 flex justify-end"><a href="/components/button" class="btn btn-primary btn-sm xl:btn-md">See component</a></div>
                  </div>
                </div>
              </div>
