            ...
            <div
              ...
              <div class="card-body">
                ...
                <div class="mt-4 flex justify-end">
                  <a href="/components/drawer" class="btn btn-primary btn-sm xl:btn-md">
                    See component
                  </a>
                </div>
              </div>
  ...
  <div
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div
              ...
              <div class="card-body">
                ...
                <div class="mt-4 flex justify-end">
                  <a href="/components/card" class="btn btn-primary btn-sm xl:btn-md">
                    See component
                  </a>
                </div>
              </div>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div
              ...
              <div class="card-body">
                ...
                <div class="mt-4 flex justify-end">
                  <a href="/components/badge" class="btn btn-primary btn-sm xl:btn-md">
                    See component
                  </a>
                </div>
              </div>
        ...
        <div tabindex="0" class="dropdown-content py-2">
          <div
            ...
            <div class="card-body">
              ...
              <div class="mt-4 flex justify-end">
                <a href="/components/button-group" class="btn btn-primary btn-sm xl:btn-md">
                  See component
                </a>
              </div>
            </div>
    ...
    <div
      ...
      <div class="card-body">
            ...
            <div tabindex="0" class="dropdown-content py-2">
              <div
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 flex justify-end">
                    <a href="/components/dropdown" class="btn btn-primary btn-sm xl:btn-md">
                      See component
                    </a>
                  </div>
                </div>
        ...
        <div class="dropdown w-full">
          <div tabindex="0">
            <div class="mb-2"><div class="badge badge-ghost">May 14th</div></div>
          </div>
          <div tabindex="0" class="dropdown-content py-2">
            <div
              class="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
        ...
        <div tabindex="0" class="dropdown-content py-2">
          <div
            ...
            <div class="card-body">
              ...
              <div class="mt-4 flex justify-end">
                <a href="/components/tab" class="btn btn-primary btn-sm xl:btn-md">See component</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div tabindex="0" class="dropdown-content py-2">
          <div
            ...
            <div class="card-body">
              ...
              <div class="mt-4 flex justify-end">
                <a href="/components/pagination" class="btn btn-primary btn-sm xl:btn-md">
                  See component
                </a>
              </div>
            </div>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div
              ...
              <div class="card-body">
                ...
                <div class="mt-4 flex justify-end">
                  <a href="/components/menu" class="btn btn-primary btn-sm xl:btn-md">
                    See component
                  </a>
                </div>
              </div>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div
              ...
              <div class="card-body">
                ...
                <div class="mt-4 flex justify-end">
                  <a href="/components/checkbox" class="btn btn-primary btn-sm xl:btn-md">
                    See component
                  </a>
                </div>
              </div>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div
              ...
              <div class="card-body">
                ...
                <div class="mt-4 flex justify-end">
                  <a href="/components/rating" class="btn btn-primary btn-sm xl:btn-md">
                    See component
                  </a>
                </div>
              </div>
          ...
          <div tabindex="0" class="dropdown-content py-2">
            <div
              ...
              <div class="card-body">
                ...
                <div class="mt-4 flex justify-end">
                  <a href="/components/breadcrumbs" class="btn btn-primary btn-sm xl:btn-md">
                    See component
                  </a>
                </div>
              </div>
