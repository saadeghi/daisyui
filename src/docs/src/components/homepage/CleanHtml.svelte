...
<div class="hero bg-base-100 text-base-content mx-auto min-h-screen max-w-md md:max-w-full">
  <div class="hero-content px-4 text-center md:px-0">
    ...
    hover:bg-indigo-700</span>"&gt;Button&lt;/a&gt;</code></pre>
        ...
        <div class="flex w-full flex-col text-left">
          <div class="mockup-code mx-auto w-full max-w-xs flex-grow shadow-lg sm:max-w-md">
            <pre><code>&lt;a class="<span
                  class="text-teal-500">btn btn-primary</span>"&gt;Button&lt;/a&gt;</code></pre>
          </div>
          <div class="mt-4 flex h-16 items-start justify-center">
  ...
  &lt;/div&gt;</code></pre>
        ...
        <div class="flex w-full flex-col text-left">
          <div
            ...
            <pre><code>&lt;input type="checkbox" class="<span
                  class="text-teal-500">toggle</span>"/&gt;</code></pre>
            <img
              loading="lazy"
              width="666"
              height="375"
              class="pointer-events-none absolute bottom-0 right-[-6.1em] hidden -rotate-90 transition duration-1000 lg:block"
              class:translate-x-60={!cleanHtmlMeme}
              class:translate-x-0={cleanHtmlMeme}
  ...
  &lt;/ul&gt;</code></pre>
        ...
        <div class="flex w-full flex-col text-left">
          <div class="mockup-code mx-auto w-full max-w-xs flex-grow shadow-lg sm:max-w-md">
            <pre class="pr-4"><code>&lt;ul class="<span
                  class="text-teal-500">menu</span> p-3 bg-base-200 rounded-xl"&gt;
  ...
  &lt;/ul&gt;</code></pre>
      ...
      <div data-sveltekit-preload-data="hover" class="mt-6 mb-10 flex w-full justify-center">
