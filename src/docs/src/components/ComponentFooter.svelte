      ...
      {#if currentPageIndex > 0}
        <a href={arrayOfPagesInOrder[currentPageIndex - 1].href} class="btn btn-sm md:btn-md btn-ghost gap-2 normal-case lg:gap-3">
          ...
          <div class="flex flex-col items-start">
            ...
            <span>{arrayOfPagesInOrder[currentPageIndex - 1].name}</span>
          </div>
        </a>
      {/if}
    </div>
    <div>
      {#if currentPageIndex < arrayOfPagesInOrder.length - 1}
    ...
    <div class="flex flex-col gap-2">
      <div class="flex items-center gap-2">
        ...
        <div>
          ...
          <a target="_blank" rel="noopener" class="link" href="https://github.com/saadeghi/daisyui/discussions">ask the community</a>
        </div>
      </div>
      <div class="flex items-center gap-2">
        ...
        <div>
          Do you see a bug?
          <a target="_blank" rel="noopener" class="link" href={`https://github.com/saadeghi/daisyui/issues?q=${arrayOfPagesInOrder[currentPageIndex].name}`}>open an issue on GitHub</a>
        </div>
      </div>
      <div class="flex items-center gap-2">
        ...
        <div>
          Do you like daisyUI?
          <a target="_blank" rel="noopener" class="link" href={`https://twitter.com/intent/tweet?text=daisyUI%20%0D%0AComponents%20for%20Tailwind%20CSS%20%0D%0Ahttps://daisyui.com`}>tweet about it!</a>
        </div>
      </div>
    </div>
    <div>
      <div class="flex items-center gap-2">
        ...
        <div>
          <a target="_blank" rel="noopener" class="link" href={`https://github.com/saadeghi/daisyui/blob/master/src/docs/src/routes${$page.url.pathname.replace(/\/$/, "")}.svelte.md?plain=1`}>Edit this page</a>
          on GitHub
        </div>
      </div>
    </div>
