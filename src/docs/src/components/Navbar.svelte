  ...
  <nav class="navbar w-full">
    ...
    <div class="flex-0">
      <div class={`hidden flex-none items-center ${$page.url.pathname == "/" ? "lg:block" : ""}`}>
        <a data-sveltekit-preload-data="hover" href="/components" class="btn btn-ghost drawer-button normal-case">
      ...
      <span class="tooltip tooltip-bottom before:text-xs before:content-[attr(data-tip)]" data-tip="GitHub">
        <div class="flex-none items-center">
          <a aria-label="Github" target="_blank" href="https://github.com/saadeghi/daisyui" rel="noopener, noreferrer" class="btn btn-ghost drawer-button btn-square normal-case">
