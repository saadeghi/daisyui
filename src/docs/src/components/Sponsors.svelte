...
{#if false}
  <div class="flex-col gap-2">
    ...
    <div class="{`flex gap-2 ${wrapperClasses}`}">
      ...
      <a
        href="https://github.com/jycouet"
        target="_blank"
        rel="nofollow, noreferrer"
        class="{`flex w-[130px] flex-col items-center rounded pt-2 ${classes}`}">
        <svg
          version="1.0"
       ...
       48 -106 113 -141 142 l-22 19 0 -223z">
        ...
        <p class="text-base-content/50 w-full px-2.5 py-2 text-xs tracking-tighter">
          Dynamic Process
        </p>
      </a>
    </div>
    ...
    target="_blank"
    rel="nofollow, noreferrer"
    class="link link-hover group text-xs opacity-80">
    Become a sponsor
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
    ...
    <a
      ...
      target="_blank"
      rel="nofollow, noreferrer"
      class="text-base-content/50 hover:text-base-content/100 text-xs">
      Become a sponsor
    </a>
  </div>
{/if}
