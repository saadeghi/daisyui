  ...
  <div>
    ...
    <Wrapper nocode>
      ...
      <p class="prose text-base-content opacity-60">
        DaisyUI works best with Tailwind CSS but you can use it as a component library with other utility-firty libraries such as Basscss
      </p>
      ...
      <div class="w-full max-w-4xl my-2">
        <div class="text-sm shadow-lg mockup-code">
          <pre><code>
  <span class="text-neutral-content text-opacity-40">&lt;link href="</span>https://cdn.jsdelivr.net/npm/basscss@latest/css/basscss.min.css<span class="text-neutral-content text-opacity-40">" rel="stylesheet" type="text/css" /&gt;</span>
