<div>
  <div class="bg-base-200 text-base-content">
    <footer class="max-w-6xl px-4 py-20 mx-auto footer">
      <div>
        <div class="inline-block text-3xl font-title"><span class="lowercase text-primary">daisy</span><span class="uppercase text-base-content">UI</span></div>
        <p class="opacity-50">Free Components library <br />for utility first CSS frameworks</p>
      </div>
      <div>
        <span class="footer-title">Guides</span> <a href="/docs/install" class="link link-hover">How to install</a> <a href="/docs/use" class="link link-hover">How to use components</a> <a href="/docs/customize" class="link link-hover">How to customize</a>
        <a href="/docs/default-themes" class="link link-hover">How to use themes</a> <a href="/core/colors" class="link link-hover">Color system</a> <a href="/docs/config" class="link link-hover">Config</a>
      </div>
      <div>
        <span class="footer-title">Links</span>
        <a target="_blank" rel="noopener" href="https://github.com/saadeghi/daisyui" class="group link link-hover">
          Github
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="inline-block w-4 opacity-0 fill-current group-hover:opacity-50"
            ><path
              fill-rule="evenodd"
      ...
      <div>
        ...
        <a target="_blank" rel="noopener" href="https://www.npmjs.com/package/daisyui" class="group link link-hover">
          ...
          ></a
        >
        <a target="_blank" rel="noopener" href="https://unpkg.com/browse/daisyui/" class="group link link-hover">
          Unpkg CDN
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="inline-block w-4 opacity-0 fill-current group-hover:opacity-50"
            ><path
              fill-rule="evenodd"
          ...
          ></a
        >
        <a target="_blank" rel="noopener" href="https://www.jsdelivr.com/package/npm/daisyui" class="group link link-hover">
          JSdeliver CDN
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="inline-block w-4 opacity-0 fill-current group-hover:opacity-50"
            ><path
              fill-rule="evenodd"
      ...
      <div>
        ...
        <a href="/tailwindplay" class="group link link-hover" target="_blank" rel="noopener">
          ...
          ></a
        >
        <a target="_blank" rel="noopener" href="https://codepen.io/saadeghi/pen/gOwWKvv" class="group link link-hover">
          Codepen
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="inline-block w-4 opacity-0 fill-current group-hover:opacity-50"
            ><path
              fill-rule="evenodd"
  ...
  <footer class="px-4 py-10 border-t footer bg-base-200 border-base-300 text-base-content footer-center">
    <div class="flex flex-col items-center justify-between w-full max-w-6xl sm:flex-row">
      <a href="https://github.com/saadeghi" rel="noopener" target="_blank" class="inline-flex items-center justify-center hover:opacity-90"
        ><div class="mr-3 avatar"><div class="p-px w-14 h-14 mask mask-squircle bg-neutral"><img src="https://github.com/saadeghi.png" alt="Pouya Saadeghi" class="mask mask-squircle" /></div></div>
        <div class="text-left">
          <p class="text-xs text-opacity-50 text-base-content">Created by</p>
      ...
      <a href="https://manasky.com" rel="nofollow" target="_blank" class="inline-block mb-4 opacity-50 link hover:opacity-80"
        ><svg viewBox="0 0 324 162" xmlns="http://www.w3.org/2000/svg" class="w-20 mt-2 fill-current"
