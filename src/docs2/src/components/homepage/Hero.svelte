<div class="hero-content w-full max-w-6xl flex-col justify-between">
  <h1 class="font-title mb-2 py-4 text-center font-extrabold lg:py-10">
  ...
  <div class="flex w-full flex-col items-center justify-center space-y-10 lg:flex-row lg:space-x-4 lg:space-y-0">
    <div class="mockup-code border-base-content w-full max-w-xs flex-1 border-2 border-opacity-20 bg-transparent text-left text-current lg:mx-0"><pre data-prefix="$"><code>npm i daisyui</code></pre></div>
