import{S as at,i as st,s as rt,C as O,w as q,x as y,y as S,z as ot,A as tt,q as F,o as G,B as K,K as nt,ag as et,k as I,m as V,g as D,d as c,e as p,t as k,c as f,a as m,h as L,b as d,H as u,a9 as N,Q as P,F as z,G as C}from"../../chunks/vendor-40028f80.js";import{M as it}from"../../chunks/_markdown-6e2c9016.js";import{p as ut,C as ct,a as J,r as R}from"../../chunks/actions-4adf376f.js";import"../../chunks/stores-1979741f.js";import"../../chunks/Ads-6d7660d9.js";import"../../chunks/index-74a0cab2.js";import"../../chunks/SEO-0c40bef6.js";import"../../chunks/preload-helper-ec9aa979.js";import"../../chunks/Translate-eca2c31f.js";function dt(v){let t,a,o,r,l,i,e,s,n,h,_,g;return{c(){t=p("div"),a=p("ul"),o=p("li"),r=p("a"),l=k("Home"),i=I(),e=p("li"),s=p("a"),n=k("Documents"),h=I(),_=p("li"),g=k("Add Document"),this.h()},l(E){t=f(E,"DIV",{class:!0});var B=m(t);a=f(B,"UL",{});var w=m(a);o=f(w,"LI",{});var b=m(o);r=f(b,"A",{});var x=m(r);l=L(x,"Home"),x.forEach(c),b.forEach(c),i=V(w),e=f(w,"LI",{});var H=m(e);s=f(H,"A",{});var $=m(s);n=L($,"Documents"),$.forEach(c),H.forEach(c),h=V(w),_=f(w,"LI",{});var j=m(_);g=L(j,"Add Document"),j.forEach(c),w.forEach(c),B.forEach(c),this.h()},h(){d(t,"class","text-sm breadcrumbs")},m(E,B){D(E,t,B),u(t,a),u(a,o),u(o,r),u(r,l),u(a,i),u(a,e),u(e,s),u(s,n),u(a,h),u(a,_),u(_,g)},d(E){E&&c(t)}}}function mt(v){let t,a=`<div class="text-sm $$breadcrumbs">
  <ul>
    <li><a>Home</a></li> 
    <li><a>Documents</a></li> 
    <li>Add Document</li>
...
</div>`,o,r,l,i;return{c(){t=p("pre"),o=k(a),this.h()},l(e){t=f(e,"PRE",{slot:!0});var s=m(t);o=L(s,a),s.forEach(c),this.h()},h(){d(t,"slot","react")},m(e,s){D(e,t,s),u(t,o),l||(i=N(r=R.call(null,t,{to:v[0]})),l=!0)},p(e,s){r&&P(r.update)&&s&1&&r.update.call(null,{to:e[0]})},d(e){e&&c(t),l=!1,i()}}}function $t(v){let t,a,o,r,l,i,e,s;return t=new ct({props:{data:[{type:"component",class:"breadcrumbs",desc:"Container element"}]}}),o=new J({props:{title:"Breadcrumbs",$$slots:{react:[ht],html:[mt],default:[dt]},$$scope:{ctx:v}}}),l=new J({props:{title:"Breadcrumbs with icons",$$slots:{react:[vt],html:[ft],default:[pt]},$$scope:{ctx:v}}}),e=new J({props:{title:"Breadcrumbs with max-width",desc:"If you set max-width or the list gets larger than the container it will scroll",$$slots:{react:[wt],html:[gt],default:[_t]},$$scope:{ctx:v}}}),{c(){q(t.$$.fragment),a=I(),q(o.$$.fragment),r=I(),q(l.$$.fragment),i=I(),q(e.$$.fragment)},l(n){y(t.$$.fragment,n),a=V(n),y(o.$$.fragment,n),r=V(n),y(l.$$.fragment,n),i=V(n),y(e.$$.fragment,n)},m(n,h){S(t,n,h),D(n,a,h),S(o,n,h),D(n,r,h),S(l,n,h),D(n,i,h),S(e,n,h),s=!0},p(n,h){const _={};h&5&&(_.$$scope={dirty:h,ctx:n}),o.$set(_);const g={};h&5&&(g.$$scope={dirty:h,ctx:n}),l.$set(g);const E={};h&5&&(E.$$scope={dirty:h,ctx:n}),e.$set(E)},i(n){s||(F(t.$$.fragment,n),F(o.$$.fragment,n),F(l.$$.fragment,n),F(e.$$.fragment,n),s=!0)},o(n){G(t.$$.fragment,n),G(o.$$.fragment,n),G(l.$$.fragment,n),G(e.$$.fragment,n),s=!1},d(n){K(t,n),n&&c(a),K(o,n),n&&c(r),K(l,n),n&&c(i),K(e,n)}}}function xt(v){let t,a;const o=[v[1],lt];let r={$$slots:{default:[$t]},$$scope:{ctx:v}};for(let l=0;l<o.length;l+=1)r=O(r,o[l]);return t=new it({props:r}),{c(){q(t.$$.fragment)},l(l){y(t.$$.fragment,l)},m(l,i){S(t,l,i),a=!0},p(l,[i]){const e=i&2?ot(o,[i&2&&tt(l[1]),i&0&&tt(lt)]):{};i&5&&(e.$$scope={dirty:i,ctx:l}),t.$set(e)},i(l){a||(F(t.$$.fragment,l),a=!0)},o(l){G(t.$$.fragment,l),a=!1},d(l){K(t,l)}}}const lt={title:"Breadcrumbs",desc:"Breadcrumbs helps users to navigate through the website.",published:!0};function kt(v,t,a){let o;return nt(v,ut,r=>a(0,o=r)),v.$$set=r=>{a(1,t=O(O({},t),et(r)))},t=et(t),[o,t]}class At extends at{constructor(t){super();st(this,t,kt,xt,rt,{})}}export{At as default,lt as metadata};
