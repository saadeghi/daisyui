import{S as Ee,i as Ne,s as ye,C as oe,w as O,x as T,y as L,z as Ie,A as _e,q as j,o as C,B as R,K as qe,ag as xe,k as I,m as q,g as S,d,e as p,t as E,c as m,a as f,h as N,b as u,F as r,a9 as V,Q as H,O as we,f as Pe}from"../../chunks/vendor-3400f70d.js";import{M as ke}from"../../chunks/_markdown-e758a68f.js";import{p as Se,C as De,a as W,r as G}from"../../chunks/actions-a8bea31e.js";import"../../chunks/stores-a971fa48.js";import"../../chunks/Ads-9d940eea.js";import"../../chunks/index-70570d09.js";import"../../chunks/SEO-bdb68965.js";import"../../chunks/preload-helper-ec9aa979.js";import"../../chunks/Translate-d7c09636.js";function Qe(v){let e,n,a,i,s,c,t,l,g,$,b;return{c(){e=p("div"),n=p("div"),a=p("div"),i=p("h3"),s=E("Hello there"),c=I(),t=p("p"),l=E("Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi."),g=I(),$=p("button"),b=E("Get Started"),this.h()},l(_){e=m(_,"DIV",{class:!0});var o=f(e);n=m(o,"DIV",{class:!0});var h=f(n);a=m(h,"DIV",{class:!0});var x=f(a);i=m(x,"H3",{class:!0});var P=f(i);s=N(P,"Hello there"),P.forEach(d),c=q(x),t=m(x,"P",{class:!0});var w=f(t);l=N(w,"Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi."),w.forEach(d),g=q(x),$=m(x,"BUTTON",{class:!0});var y=f($);b=N(y,"Get Started"),y.forEach(d),x.forEach(d),h.forEach(d),o.forEach(d),this.h()},h(){u(i,"class","text-5xl font-bold"),u(t,"class","py-6"),u($,"class","btn btn-primary"),u(a,"class","max-w-md"),u(n,"class","text-center hero-content"),u(e,"class","hero min-h-[30rem] rounded bg-base-200")},m(_,o){S(_,e,o),r(e,n),r(n,a),r(a,i),r(i,s),r(a,c),r(a,t),r(t,l),r(a,g),r(a,$),r($,b)},d(_){_&&d(e)}}}function Ve(v){let e,n=`<div class="$$hero min-h-screen bg-base-200">
...
</div>`,a,i,s,c;return{c(){e=p("pre"),a=E(n),this.h()},l(t){e=m(t,"PRE",{slot:!0});var l=f(e);a=N(l,n),l.forEach(d),this.h()},h(){u(e,"slot","html")},m(t,l){S(t,e,l),r(e,a),s||(c=V(i=G.call(null,e,{to:v[0]})),s=!0)},p(t,l){i&&H(i.update)&&l&1&&i.update.call(null,{to:t[0]})},d(t){t&&d(e),s=!1,c()}}}function He(v){let e,n=`<div className="$$hero min-h-screen bg-base-200">
...
</div>`,a,i,s,c;return{c(){e=p("pre"),a=E(n),this.h()},l(t){e=m(t,"PRE",{slot:!0});var l=f(e);a=N(l,n),l.forEach(d),this.h()},h(){u(e,"slot","html")},m(t,l){S(t,e,l),r(e,a),s||(c=V(i=G.call(null,e,{to:v[0]})),s=!0)},p(t,l){i&&H(i.update)&&l&1&&i.update.call(null,{to:t[0]})},d(t){t&&d(e),s=!1,c()}}}function Oe(v){let e,n=`<div className="$$hero min-h-screen bg-base-200">
...
</div>`,a,i,s,c;return{c(){e=p("pre"),a=E(n),this.h()},l(t){e=m(t,"PRE",{slot:!0});var l=f(e);a=N(l,n),l.forEach(d),this.h()},h(){u(e,"slot","html")},m(t,l){S(t,e,l),r(e,a),s||(c=V(i=G.call(null,e,{to:v[0]})),s=!0)},p(t,l){i&&H(i.update)&&l&1&&i.update.call(null,{to:t[0]})},d(t){t&&d(e),s=!1,c()}}}function je(v){let e,n=`<div className="$$hero min-h-screen bg-base-200">
...
</div>`,a,i,s,c;return{c(){e=p("pre"),a=E(n),this.h()},l(t){e=m(t,"PRE",{slot:!0});var l=f(e);a=N(l,n),l.forEach(d),this.h()},h(){u(e,"slot","html")},m(t,l){S(t,e,l),r(e,a),s||(c=V(i=G.call(null,e,{to:v[0]})),s=!0)},p(t,l){i&&H(i.update)&&l&1&&i.update.call(null,{to:t[0]})},d(t){t&&d(e),s=!1,c()}}}function Ae(v){let e,n=`<div className="$$hero min-h-screen bg-base-200">
  <div className="$$hero-content flex-col lg:flex-row-reverse">
...
</div>`,a,i,s,c;return{c(){e=p("pre"),a=E(n),this.h()},l(t){e=m(t,"PRE",{slot:!0});var l=f(e);a=N(l,n),l.forEach(d),this.h()},h(){u(e,"slot","html")},m(t,l){S(t,e,l),r(e,a),s||(c=V(i=G.call(null,e,{to:v[0]})),s=!0)},p(t,l){i&&H(i.update)&&l&1&&i.update.call(null,{to:t[0]})},d(t){t&&d(e),s=!1,c()}}}function Me(v){let e,n=`<div className="$$hero min-h-screen" style={{ backgroundImage: \`url("/images/stock/photo-1507358522600-9f71e620c44e.jpg")\` }}>
