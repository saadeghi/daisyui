import{S as Ft,i as Tt,s as Kt,w as nt,k as p,x as ut,m as _,y as ht,g as Y,q as ft,o as mt,B as pt,d as a,e as r,t as h,c as v,a as l,h as f,b as e,H as t,K as wt,F as ct,G as ot,L as jt}from"../../chunks/vendor-6c3f1da5.js";import{C as Ut,a as _t}from"../../chunks/ClassTable-96235e25.js";import"../../chunks/preload-helper-ec9aa979.js";function Pt(O){let s,i,o,c,n,g,b,P,E,x;return{c(){s=r("div"),i=r("div"),o=r("div"),c=h("Total Page Views"),n=p(),g=r("div"),b=h("89,400"),P=p(),E=r("div"),x=h("21% more than last month"),this.h()},l(N){s=v(N,"DIV",{class:!0});var $=l(s);i=v($,"DIV",{class:!0});var m=l(i);o=v(m,"DIV",{class:!0});var T=l(o);c=f(T,"Total Page Views"),T.forEach(a),n=_(m),g=v(m,"DIV",{class:!0});var M=l(g);b=f(M,"89,400"),M.forEach(a),P=_(m),E=v(m,"DIV",{class:!0});var w=l(E);x=f(w,"21% more than last month"),w.forEach(a),m.forEach(a),$.forEach(a),this.h()},h(){e(o,"class","stat-title"),e(g,"class","stat-value"),e(E,"class","stat-desc"),e(i,"class","stat"),e(s,"class","shadow stats")},m(N,$){Y(N,s,$),t(s,i),t(i,o),t(o,c),t(i,n),t(i,g),t(g,b),t(i,P),t(i,E),t(E,x)},d(N){N&&a(s)}}}function Jt(O){let s,i=`<div class="shadow stats">
