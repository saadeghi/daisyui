import{S as jt,i as Kt,s as Ut,w as nt,k as w,x as ut,m as E,y as $t,g as Y,q as ht,o as ft,B as mt,d as a,J as Pt,e as v,t as m,c,a as i,h as p,b as e,H as t,a1 as _t,P as wt,F as ct,G as ot,N as Jt}from"../../chunks/vendor-1fc5b034.js";import{C as zt,a as pt,r as Et,p as St}from"../../chunks/actions-a46bfef7.js";import"../../chunks/preload-helper-ec9aa979.js";function Ct(z){let s,l,o,n,$,h,r,u,D,y;return{c(){s=v("div"),l=v("div"),o=v("div"),n=m("Total Page Views"),$=w(),h=v("div"),r=m("89,400"),u=w(),D=v("div"),y=m("21% more than last month"),this.h()},l(M){s=c(M,"DIV",{class:!0});var V=i(s);l=c(V,"DIV",{class:!0});var _=i(l);o=c(_,"DIV",{class:!0});var j=i(o);n=p(j,"Total Page Views"),j.forEach(a),$=E(_),h=c(_,"DIV",{class:!0});var R=i(h);r=p(R,"89,400"),R.forEach(a),u=E(_),D=c(_,"DIV",{class:!0});var g=i(D);y=p(g,"21% more than last month"),g.forEach(a),_.forEach(a),V.forEach(a),this.h()},h(){e(o,"class","stat-title"),e(h,"class","stat-value"),e(D,"class","stat-desc"),e(l,"class","stat"),e(s,"class","shadow stats")},m(M,V){Y(M,s,V),t(s,l),t(l,o),t(o,n),t(l,$),t(l,h),t(h,r),t(l,u),t(l,D),t(D,y)},d(M){M&&a(s)}}}function Lt(z){let s,l=`<div class="$$stats shadow">
