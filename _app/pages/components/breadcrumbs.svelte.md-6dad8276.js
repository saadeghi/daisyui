import{S as at,i as st,s as rt,C as Q,w as q,x as y,y as S,z as ot,A as tt,q as F,o as K,B as T,K as nt,ag as et,k as I,m as V,g as D,d as c,e as p,t as k,c as f,a as m,h as L,b as d,F as u,a9 as N,W as P,H as z,I as C}from"../../chunks/vendor-c5cb7521.js";import{M as it}from"../../chunks/_markdown-fbd53b8e.js";import{p as ut,C as ct,a as O,r as R}from"../../chunks/actions-d587e10a.js";import"../../chunks/stores-596c3501.js";import"../../chunks/Ads-fdc00837.js";import"../../chunks/index-12abe7b3.js";import"../../chunks/SEO-3d5428d1.js";import"../../chunks/preload-helper-ec9aa979.js";import"../../chunks/Translate-d7e3dfdd.js";function dt(v){let t,a,o,r,l,i,e,s,n,h,_,g;return{c(){t=p("div"),a=p("ul"),o=p("li"),r=p("a"),l=k("Home"),i=I(),e=p("li"),s=p("a"),n=k("Documents"),h=I(),_=p("li"),g=k("Add Document"),this.h()},l(E){t=f(E,"DIV",{class:!0});var B=m(t);a=f(B,"UL",{});var w=m(a);o=f(w,"LI",{});var b=m(o);r=f(b,"A",{});var x=m(r);l=L(x,"Home"),x.forEach(c),b.forEach(c),i=V(w),e=f(w,"LI",{});var H=m(e);s=f(H,"A",{});var $=m(s);n=L($,"Documents"),$.forEach(c),H.forEach(c),h=V(w),_=f(w,"LI",{});var j=m(_);g=L(j,"Add Document"),j.forEach(c),w.forEach(c),B.forEach(c),this.h()},h(){d(t,"class","text-sm breadcrumbs")},m(E,B){D(E,t,B),u(t,a),u(a,o),u(o,r),u(r,l),u(a,i),u(a,e),u(e,s),u(s,n),u(a,h),u(a,_),u(_,g)},d(E){E&&c(t)}}}function mt(v){let t,a=`<div class="text-sm $$breadcrumbs">
  <ul>
    <li><a>Home</a></li> 
    <li><a>Documents</a></li> 
    <li>Add Document</li>
