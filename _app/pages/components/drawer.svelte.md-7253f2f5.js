import{S as Ae,i as Ve,s as Te,C as me,w as G,x as K,y as Q,z as je,A as Ne,q as W,o as X,B as Z,K as Be,ag as Se,k as E,e as d,t as I,m as x,c,a as u,h as k,d as l,b as i,g as V,H as a,a9 as q,Q as H,F as Le,G as De}from"../../chunks/vendor-40028f80.js";import{M as Me}from"../../chunks/_markdown-9efdc8c6.js";import{p as Oe,C as Ce,a as ie,r as J}from"../../chunks/actions-fd84554f.js";import"../../chunks/stores-1979741f.js";import"../../chunks/Ads-72a0f3b6.js";import"../../chunks/index-78663a61.js";import"../../chunks/SEO-4b3b2a73.js";import"../../chunks/preload-helper-ec9aa979.js";import"../../chunks/Translate-b1943c0a.js";function Fe(w){let e,m,p,o,s,f,r,t,$,O,h,_,L,D,P,N,y,A;return{c(){e=d("div"),m=d("input"),p=E(),o=d("div"),s=d("label"),f=I("Open drawer"),r=E(),t=d("div"),$=d("label"),O=E(),h=d("ul"),_=d("li"),L=d("a"),D=I("Sidebar Item 1"),P=E(),N=d("li"),y=d("a"),A=I("Sidebar Item 2"),this.h()},l(S){e=c(S,"DIV",{class:!0});var v=u(e);m=c(v,"INPUT",{id:!0,type:!0,class:!0}),p=x(v),o=c(v,"DIV",{class:!0});var M=u(o);s=c(M,"LABEL",{for:!0,class:!0});var j=u(s);f=k(j,"Open drawer"),j.forEach(l),M.forEach(l),r=x(v),t=c(v,"DIV",{class:!0});var T=u(t);$=c(T,"LABEL",{for:!0,class:!0}),u($).forEach(l),O=x(T),h=c(T,"UL",{class:!0});var g=u(h);_=c(g,"LI",{});var C=u(_);L=c(C,"A",{});var n=u(L);D=k(n,"Sidebar Item 1"),n.forEach(l),C.forEach(l),P=x(g),N=c(g,"LI",{});var b=u(N);y=c(b,"A",{});var B=u(y);A=k(B,"Sidebar Item 2"),B.forEach(l),b.forEach(l),g.forEach(l),T.forEach(l),v.forEach(l),this.h()},h(){i(m,"id","my-drawer"),i(m,"type","checkbox"),i(m,"class","drawer-toggle"),i(s,"for","my-drawer"),i(s,"class","btn btn-primary drawer-button"),i(o,"class","flex flex-col items-center justify-center drawer-content"),i($,"for","my-drawer"),i($,"class","drawer-overlay"),i(h,"class","menu p-4 w-60 md:w-80 bg-base-100 text-base-content"),i(t,"class","drawer-side"),i(e,"class","drawer h-56 rounded")},m(S,v){V(S,e,v),a(e,m),a(e,p),a(e,o),a(o,s),a(s,f),a(e,r),a(e,t),a(t,$),a(t,O),a(t,h),a(h,_),a(_,L),a(L,D),a(h,P),a(h,N),a(N,y),a(y,A)},d(S){S&&l(e)}}}function Re(w){let e,m=`<div class="$$drawer">
...
</div>`,p,o,s,f;return{c(){e=d("pre"),p=I(m),this.h()},l(r){e=c(r,"PRE",{slot:!0});var t=u(e);p=k(t,m),t.forEach(l),this.h()},h(){i(e,"slot","html")},m(r,t){V(r,e,t),a(e,p),s||(f=q(o=J.call(null,e,{to:w[0]})),s=!0)},p(r,t){o&&H(o.update)&&t&1&&o.update.call(null,{to:r[0]})},d(r){r&&l(e),s=!1,f()}}}function Ge(w){let e,m=`<div className="$$drawer">
...
</div>`,p,o,s,f;return{c(){e=d("pre"),p=I(m),this.h()},l(r){e=c(r,"PRE",{slot:!0});var t=u(e);p=k(t,m),t.forEach(l),this.h()},h(){i(e,"slot","html")},m(r,t){V(r,e,t),a(e,p),s||(f=q(o=J.call(null,e,{to:w[0]})),s=!0)},p(r,t){o&&H(o.update)&&t&1&&o.update.call(null,{to:r[0]})},d(r){r&&l(e),s=!1,f()}}}function We(w){let e,m=`<div className="$$drawer $$drawer-end">
  ...
  \u2514\u2500\u2500 <span class="token punctuation">.</span>drawer<span class="token operator">-</span>side <span class="token comment">// Sidebar wrapper</span>
       ...
       \u2514\u2500\u2500 <span class="token comment">// Sidebar content (menu or anything)</span></code>`,h,_,L,D,P,N,y,A,S,v,M,j,T,g,C;return e=new Ce({props:{data:[{type:"component",class:"drawer",desc:"Container element"},{type:"component",class:"drawer-toggle",desc:"For checkbox element that controls the drawer"},{type:"component",class:"drawer-content",desc:"The content container"},{type:"component",class:"drawer-side",desc:"The sidebar container"},{type:"component",class:"drawer-overlay",desc:"The label covers the content when drawer is open"},{type:"modifier",class:"drawer-mobile",desc:"Makes drawer to open/close on mobile but will be always visible on desktop"},{type:"modifier",class:"drawer-end",desc:"puts drawer to the right"}]}}),A=new ie({props:{title:"Drawer",$$slots:{react:[ze],html:[Re],default:[Fe]},$$scope:{ctx:w}}}),v=new ie({props:{title:"Drawer for mobile + fixed sidebar for desktop",desc:"Drawer is always open on desktop size. Drawer can be toggled on mobile size. Resize the browser to see toggle button on mobile size",$$slots:{react:[He],html:[qe],default:[Ue]},$$scope:{ctx:w}}}),j=new ie({props:{title:"Navbar menu for desktop + sidebar drawer for mobile",desc:"Change screen size to show/hide menu",$$slots:{react:[Ge],html:[Ye],default:[Je]},$$scope:{ctx:w}}}),g=new ie({props:{title:"Drawer that opens from right side of page",$$slots:{react:[We],html:[Qe],default:[Ke]},$$scope:{ctx:w}}}),{c(){G(e.$$.fragment),m=E(),p=d("p"),o=I("Drawer sidebar can be visible by default on large screens or it can be toggleable on both large and small screens."),s=E(),f=d("p"),r=I("Drawer tags structure:"),t=E(),$=d("pre"),h=E(),_=d("p"),L=I("You can check/uncheck the checkbox using JavaScript or using "),D=d("code"),P=I("<label>"),N=I(" tag."),y=E(),G(A.$$.fragment),S=E(),G(v.$$.fragment),M=E(),G(j.$$.fragment),T=E(),G(g.$$.fragment),this.h()},l(n){K(e.$$.fragment,n),m=x(n),p=c(n,"P",{});var b=u(p);o=k(b,"Drawer sidebar can be visible by default on large screens or it can be toggleable on both large and small screens."),b.forEach(l),s=x(n),f=c(n,"P",{});var B=u(f);r=k(B,"Drawer tags structure:"),B.forEach(l),t=x(n),$=c(n,"PRE",{class:!0});var z=u($);z.forEach(l),h=x(n),_=c(n,"P",{});var F=u(_);L=k(F,"You can check/uncheck the checkbox using JavaScript or using "),D=c(F,"CODE",{});var R=u(D);P=k(R,"<label>"),R.forEach(l),N=k(F," tag."),F.forEach(l),y=x(n),K(A.$$.fragment,n),S=x(n),K(v.$$.fragment,n),M=x(n),K(j.$$.fragment,n),T=x(n),K(g.$$.fragment,n),this.h()},h(){i($,"class","language-js")},m(n,b){Q(e,n,b),V(n,m,b),V(n,p,b),a(p,o),V(n,s,b),V(n,f,b),a(f,r),V(n,t,b),V(n,$,b),$.innerHTML=O,V(n,h,b),V(n,_,b),a(_,L),a(_,D),a(D,P),a(_,N),V(n,y,b),Q(A,n,b),V(n,S,b),Q(v,n,b),V(n,M,b),Q(j,n,b),V(n,T,b),Q(g,n,b),C=!0},p(n,b){const B={};b&5&&(B.$$scope={dirty:b,ctx:n}),A.$set(B);const z={};b&5&&(z.$$scope={dirty:b,ctx:n}),v.$set(z);const F={};b&5&&(F.$$scope={dirty:b,ctx:n}),j.$set(F);const R={};b&5&&(R.$$scope={dirty:b,ctx:n}),g.$set(R)},i(n){C||(W(e.$$.fragment,n),W(A.$$.fragment,n),W(v.$$.fragment,n),W(j.$$.fragment,n),W(g.$$.fragment,n),C=!0)},o(n){X(e.$$.fragment,n),X(A.$$.fragment,n),X(v.$$.fragment,n),X(j.$$.fragment,n),X(g.$$.fragment,n),C=!1},d(n){Z(e,n),n&&l(m),n&&l(p),n&&l(s),n&&l(f),n&&l(t),n&&l($),n&&l(h),n&&l(_),n&&l(y),Z(A,n),n&&l(S),Z(v,n),n&&l(M),Z(j,n),n&&l(T),Z(g,n)}}}function Ze(w){let e,m;const p=[w[1],Pe];let o={$$slots:{default:[Xe]},$$scope:{ctx:w}};for(let s=0;s<p.length;s+=1)o=me(o,p[s]);return e=new Me({props:o}),{c(){G(e.$$.fragment)},l(s){K(e.$$.fragment,s)},m(s,f){Q(e,s,f),m=!0},p(s,[f]){const r=f&2?je(p,[f&2&&Ne(s[1]),f&0&&Ne(Pe)]):{};f&5&&(r.$$scope={dirty:f,ctx:s}),e.$set(r)},i(s){m||(W(e.$$.fragment,s),m=!0)},o(s){X(e.$$.fragment,s),m=!1},d(s){Z(e,s)}}}const Pe={title:"Drawer",desc:"Drawer is a grid layout that can show/hide a sidebar on the left or right side of the page.",published:!0};function ea(w,e,m){let p;return Be(w,Oe,o=>m(0,p=o)),w.$$set=o=>{m(1,e=me(me({},e),Se(o)))},e=Se(e),[p,e]}class ca extends Ae{constructor(e){super();Ve(this,e,ea,Ze,Te,{})}}export{ca as default,Pe as metadata};
