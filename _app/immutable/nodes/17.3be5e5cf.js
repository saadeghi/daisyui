import{s as S,y as L,m as F,z as y,a as b,d as k,j as p,h as m,e as d,c as h,g as M,i as f,n as D,t as B,b as V,f as j,k as C,C as z,D as T}from"../chunks/scheduler.f50f852b.js";import{S as G,i as J,c as _,a as v,m as g,t as $,b as w,d as x}from"../chunks/index.90b433aa.js";import{g as K,a as R}from"../chunks/spread.8a54911c.js";import{M as N,p as O,C as Q,a as H,r as E}from"../chunks/ClassTable.060ca9dc.js";function U(c){let e,r='<ul><li><span class="hover:underline cursor-pointer inline-flex gap-2 items-center">Home</span></li> <li><span class="hover:underline cursor-pointer inline-flex gap-2 items-center">Documents</span></li> <li>Add Document</li></ul>';return{c(){e=d("div"),e.innerHTML=r,this.h()},l(t){e=h(t,"DIV",{class:!0,"data-svelte-h":!0}),M(e)!=="svelte-19d4qk"&&(e.innerHTML=r),this.h()},h(){f(e,"class","text-sm breadcrumbs")},m(t,a){p(t,e,a)},p:D,d(t){t&&m(e)}}}function W(c){let e,r=`<div class="text-sm $$breadcrumbs">
  <ul>
    <li><a>Home</a></li> 
    <li><a>Documents</a></li> 
    <li>Add Document</li>
  </ul>
</div>`,t,a,s,i;return{c(){e=d("pre"),t=B(r),this.h()},l(l){e=h(l,"PRE",{slot:!0});var o=V(e);t=j(o,r),o.forEach(m),this.h()},h(){f(e,"slot","html")},m(l,o){p(l,e,o),C(e,t),s||(i=z(a=E.call(null,e,{to:c[0]})),s=!0)},p(l,o){a&&T(a.update)&&o&1&&a.update.call(null,{to:l[0]})},d(l){l&&m(e),s=!1,i()}}}function X(c){let e,r=`<ul><li><span class="hover:underline cursor-pointer inline-flex gap-2 items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="w-4 h-4 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path></svg>
