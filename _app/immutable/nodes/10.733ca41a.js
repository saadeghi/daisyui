import{S as it,i as nt,s as ot,Q as U,r as x,v as C,w as S,R as rt,T as at,A as j,B as M,C as A,o as dt,U as st,a as b,g as w,k as c,f as d,e as $,c as g,h as T,j as h,n as L,t as D,b as I,d as V,l as E,X as P,Y as R}from"../chunks/vendor.140da208.js";import{M as ct,p as vt,C as pt,a as H,r as q}from"../chunks/ClassTable.7ae24326.js";function ut(v){let t,r='<div class="w-24 rounded bg-base-300"><img src="/images/stock/photo-1534528741775-53994a69daeb.jpg" alt="Tailwind-CSS-Avatar-component"/></div>';return{c(){t=$("div"),t.innerHTML=r,this.h()},l(s){t=g(s,"DIV",{class:!0,"data-svelte-h":!0}),T(t)!=="svelte-tk0hy4"&&(t.innerHTML=r),this.h()},h(){h(t,"class","avatar")},m(s,a){c(s,t,a)},p:L,d(s){s&&d(t)}}}function mt(v){let t,r=`<div class="$$avatar">
...
</div>`,s,a,i,o;return{c(){t=$("pre"),s=D(r),this.h()},l(e){t=g(e,"PRE",{slot:!0});var n=I(t);s=V(n,r),n.forEach(d),this.h()},h(){h(t,"slot","html")},m(e,n){c(e,t,n),E(t,s),i||(o=P(a=q.call(null,t,{to:v[0]})),i=!0)},p(e,n){a&&R(a.update)&&n&1&&a.update.call(null,{to:e[0]})},d(e){e&&d(t),i=!1,o()}}}function Lt(v){let t,r,s,a,i,o,e,n,m,f,k,p,_,K,z,O,X,B,J,Q;return t=new pt({props:{data:[{type:"component",class:"avatar",desc:"Container element"},{type:"component",class:"avatar-group",desc:"Container for grouping multiple avatars"},{type:"modifier",class:"online",desc:"shows a green dot as online indicator"},{type:"modifier",class:"offline",desc:"shows a gray dot as offline indicator"},{type:"modifier",class:"placeholder",desc:"to show some letters as avatar placeholder"}]}}),s=new H({props:{title:"Avatar",$$slots:{html:[mt],default:[ut]},$$scope:{ctx:v}}}),i=new H({props:{title:"Avatar in custom sizes",$$slots:{html:[$t],default:[ft]},$$scope:{ctx:v}}}),e=new H({props:{title:"Avatar rounded",$$slots:{html:[ht],default:[gt]},$$scope:{ctx:v}}}),m=new H({props:{title:"Avatar with mask",$$slots:{html:[bt],default:[_t]},$$scope:{ctx:v}}}),k=new H({props:{title:"Avatar group",$$slots:{html:[Tt],default:[wt]},$$scope:{ctx:v}}}),_=new H({props:{title:"Avatar group with counter",$$slots:{html:[xt],default:[kt]},$$scope:{ctx:v}}}),z=new H({props:{title:"Avatar with ring",$$slots:{html:[St],default:[Ct]},$$scope:{ctx:v}}}),X=new H({props:{title:"Avatar with presence indicator",$$slots:{html:[Mt],default:[jt]},$$scope:{ctx:v}}}),J=new H({props:{title:"Avatar placeholder",$$slots:{html:[Ht],default:[At]},$$scope:{ctx:v}}}),{c(){x(t.$$.fragment),r=b(),x(s.$$.fragment),a=b(),x(i.$$.fragment),o=b(),x(e.$$.fragment),n=b(),x(m.$$.fragment),f=b(),x(k.$$.fragment),p=b(),x(_.$$.fragment),K=b(),x(z.$$.fragment),O=b(),x(X.$$.fragment),B=b(),x(J.$$.fragment)},l(l){C(t.$$.fragment,l),r=w(l),C(s.$$.fragment,l),a=w(l),C(i.$$.fragment,l),o=w(l),C(e.$$.fragment,l),n=w(l),C(m.$$.fragment,l),f=w(l),C(k.$$.fragment,l),p=w(l),C(_.$$.fragment,l),K=w(l),C(z.$$.fragment,l),O=w(l),C(X.$$.fragment,l),B=w(l),C(J.$$.fragment,l)},m(l,u){S(t,l,u),c(l,r,u),S(s,l,u),c(l,a,u),S(i,l,u),c(l,o,u),S(e,l,u),c(l,n,u),S(m,l,u),c(l,f,u),S(k,l,u),c(l,p,u),S(_,l,u),c(l,K,u),S(z,l,u),c(l,O,u),S(X,l,u),c(l,B,u),S(J,l,u),Q=!0},p(l,u){const Y={};u&5&&(Y.$$scope={dirty:u,ctx:l}),s.$set(Y);const F={};u&5&&(F.$$scope={dirty:u,ctx:l}),i.$set(F);const G={};u&5&&(G.$$scope={dirty:u,ctx:l}),e.$set(G);const N={};u&5&&(N.$$scope={dirty:u,ctx:l}),m.$set(N);const W={};u&5&&(W.$$scope={dirty:u,ctx:l}),k.$set(W);const Z={};u&5&&(Z.$$scope={dirty:u,ctx:l}),_.$set(Z);const y={};u&5&&(y.$$scope={dirty:u,ctx:l}),z.$set(y);const tt={};u&5&&(tt.$$scope={dirty:u,ctx:l}),X.$set(tt);const et={};u&5&&(et.$$scope={dirty:u,ctx:l}),J.$set(et)},i(l){Q||(j(t.$$.fragment,l),j(s.$$.fragment,l),j(i.$$.fragment,l),j(e.$$.fragment,l),j(m.$$.fragment,l),j(k.$$.fragment,l),j(_.$$.fragment,l),j(z.$$.fragment,l),j(X.$$.fragment,l),j(J.$$.fragment,l),Q=!0)},o(l){M(t.$$.fragment,l),M(s.$$.fragment,l),M(i.$$.fragment,l),M(e.$$.fragment,l),M(m.$$.fragment,l),M(k.$$.fragment,l),M(_.$$.fragment,l),M(z.$$.fragment,l),M(X.$$.fragment,l),M(J.$$.fragment,l),Q=!1},d(l){l&&(d(r),d(a),d(o),d(n),d(f),d(p),d(K),d(O),d(B)),A(t,l),A(s,l),A(i,l),A(e,l),A(m,l),A(k,l),A(_,l),A(z,l),A(X,l),A(J,l)}}}function Dt(v){let t,r;const s=[v[1],lt];let a={$$slots:{default:[Lt]},$$scope:{ctx:v}};for(let i=0;i<s.length;i+=1)a=U(a,s[i]);return t=new ct({props:a}),{c(){x(t.$$.fragment)},l(i){C(t.$$.fragment,i)},m(i,o){S(t,i,o),r=!0},p(i,[o]){const e=o&2?rt(s,[o&2&&at(i[1]),o&0&&at(lt)]):{};o&5&&(e.$$scope={dirty:o,ctx:i}),t.$set(e)},i(i){r||(j(t.$$.fragment,i),r=!0)},o(i){M(t.$$.fragment,i),r=!1},d(i){A(t,i)}}}const lt={title:"Avatar",desc:"Avatars are used to show a thumbnail representation of an individual or business in the interface.",published:!0,layout:"components"};function It(v,t,r){let s;return dt(v,vt,a=>r(0,s=a)),v.$$set=a=>{r(1,t=U(U({},t),st(a)))},t=st(t),[s,t]}class Pt extends it{constructor(t){super(),nt(this,t,It,Dt,ot,{})}}export{Pt as component};
