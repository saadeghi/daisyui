...
</dialog>`,o,e,d,s;return{c(){t=p("pre"),o=x(i),this.h()},l(l){t=f(l,"PRE",{slot:!0});var n=g(t);o=k(n,i),n.forEach(c),this.h()},h(){m(t,"slot","html")},m(l,n){u(l,t,n),$(t,o),d||(s=y(e=C.call(null,t,{to:r[0]})),d=!0)},p(l,n){e&&w(e.update)&&n&1&&e.update.call(null,{to:l[0]})},d(l){l&&c(t),d=!1,s()}}}function Gt(r){let t,i=`{/* You can open the modal using document.getElementById('ID').showModal() method */}
...
</div>`,o,e,d,s;return{c(){t=p("pre"),o=x(i),this.h()},l(l){t=f(l,"PRE",{slot:!0});var n=g(t);o=k(n,i),n.forEach(c),this.h()},h(){m(t,"slot","html")},m(l,n){u(l,t,n),$(t,o),d||(s=y(e=C.call(null,t,{to:r[0]})),d=!0)},p(l,n){e&&w(e.update)&&n&1&&e.update.call(null,{to:l[0]})},d(l){l&&c(t),d=!1,s()}}}function se(r){let t,i,o,e,d,s,l,n,$t='<li>Using <code>&lt;dialog&gt;</code> element: It needs JS to open but it has better accessibility and we can close it using <span class="kbd kbd-xs">Esc</span> key</li> <li>Using a hidden <code>&lt;input type=&quot;checkbox&quot;&gt;</code> and <code>&lt;label&gt;</code> to check/uncheck the checkbox and open/close the modal</li> <li>Using <code>&lt;a&gt;</code> anchor links: A link adds a parameter to the URL and you only see the modal when the URL has that parameter</li>',et,P,L,D,pt,Q,F,lt,j,bt='<a aria-hidden="true" tabindex="-1" href="#method-1-using-dialog-element-recommended"><span class="mr-1 opacity-20 hover:opacity-60 text-base font-bold inline-block align-middle relative -mt-1">#</span></a>Method 1: using dialog element <span class="badge badge-success">recommended</span>',ot,B,st,S,at,O,nt,R,dt,A,it,U,_t='<a aria-hidden="true" tabindex="-1" href="#method-2-using-a-hidden-checkbox-legacy"><span class="mr-1 opacity-20 hover:opacity-60 text-base font-bold inline-block align-middle relative -mt-1">#</span></a>Method 2: using a hidden checkbox <span class="badge badge-warning">legacy</span>',ct,Y,mt,q,rt,z,gt='<a aria-hidden="true" tabindex="-1" href="#method-3-using-anchor-links-legacy"><span class="mr-1 opacity-20 hover:opacity-60 text-base font-bold inline-block align-middle relative -mt-1">#</span></a>Method 3: using anchor links <span class="badge badge-warning">legacy</span>',ut,G,ht;return t=new Bt({props:{data:[{type:"component",class:"modal",desc:"Container element"},{type:"component",class:"modal-box",desc:"The content of modal"},{type:"component",class:"modal-action",desc:"Container for modal action buttons"},{type:"component",class:"modal-backdrop",desc:"The backdrop that covers the back of modal so we can close the modal by clicking outside"},{type:"component",class:"modal-toggle",desc:"For hidden checkbox that controls modal"},{type:"modifier",class:"modal-open",desc:"Add/remove this class to open/close the modal using JS"},{type:"responsive",class:"modal-top",desc:"Moves the modal to top"},{type:"responsive",class:"modal-bottom",desc:"Moves the modal to bottom"},{type:"responsive",class:"modal-middle",desc:"Moves the modal to middle (default)"}]}}),s=new Et({props:{text:"There are 3 ways to use a modal:"}}),F=new Et({props:{text:"Make sure you're using unique IDs for each modal"}}),B=new V({props:{title:"Dialog modal",desc:"opens on click using ID.showModal() method. can be closed using ID.close() method",$$slots:{jsx:[Rt],html:[Ot],default:[St]},$$scope:{ctx:r}}}),S=new V({props:{title:"Dialog modal, closes when clicked outside",desc:"there a second form with 'modal-backdrop' class and it covers the screen so we can close the modal when clicked outside",$$slots:{jsx:[Yt],html:[Ut],default:[At]},$$scope:{ctx:r}}}),O=new V({props:{title:"Dialog modal with a close button at corner",$$slots:{jsx:[Gt],html:[zt],default:[qt]},$$scope:{ctx:r}}}),R=new V({props:{title:"Dialog modal with custom width",desc:"You can use any w-* and max-w-* utility class to customize the width",$$slots:{jsx:[Ft],html:[Jt],default:[Vt]},$$scope:{ctx:r}}}),A=new V({props:{title:"Responsive",desc:"Modal goes bottom on mobile screen and goes middle on desktop",$$slots:{jsx:[Qt],html:[Kt],default:[Xt]},$$scope:{ctx:r}}}),Y=new V({props:{title:"Modal using label + hidden checkbox",$$slots:{html:[Zt],default:[Wt]},$$scope:{ctx:r}}}),q=new V({props:{title:"Modal that closes when clicked outside",desc:"Modal works with a hidden checkbox and labels can toggle the checkbox so we can use another label tag with 'modal-backdrop' class that covers the screen so we can close the modal when clicked outside",$$slots:{html:[ee],default:[te]},$$scope:{ctx:r}}}),G=new V({props:{title:"Modal using anchor link",desc:"Anchor links might not work well on some SPA frameworks so if there are problems, use the first example",$$slots:{html:[oe],default:[le]},$$scope:{ctx:r}}}),{c(){M(t.$$.fragment),i=b(),o=p("div"),e=p("div"),d=p("span"),M(s.$$.fragment),l=b(),n=p("ol"),n.innerHTML=$t,et=b(),P=p("div"),L=wt("svg"),D=wt("path"),pt=b(),Q=p("div"),M(F.$$.fragment),lt=b(),j=p("h3"),j.innerHTML=bt,ot=b(),M(B.$$.fragment),st=b(),M(S.$$.fragment),at=b(),M(O.$$.fragment),nt=b(),M(R.$$.fragment),dt=b(),M(A.$$.fragment),it=b(),U=p("h3"),U.innerHTML=_t,ct=b(),M(Y.$$.fragment),mt=b(),M(q.$$.fragment),rt=b(),z=p("h3"),z.innerHTML=gt,ut=b(),M(G.$$.fragment),this.h()},l(a){E(t.$$.fragment,a),i=_(a),o=f(a,"DIV",{class:!0});var h=g(o);e=f(h,"DIV",{});var X=g(e);d=f(X,"SPAN",{class:!0});var W=g(d);E(s.$$.fragment,W),W.forEach(c),l=_(X),n=f(X,"OL",{"data-svelte-h":!0}),v(n)!=="svelte-1ii7k10"&&(n.innerHTML=$t),X.forEach(c),h.forEach(c),et=_(a),P=f(a,"DIV",{class:!0});var K=g(P);L=Ct(K,"svg",{xmlns:!0,fill:!0,viewBox:!0,class:!0});var Z=g(L);D=Ct(Z,"path",{"stroke-linecap":!0,"stroke-linejoin":!0,"stroke-width":!0,d:!0}),g(D).forEach(c),Z.forEach(c),pt=_(K),Q=f(K,"DIV",{});var tt=g(Q);E(F.$$.fragment,tt),tt.forEach(c),K.forEach(c),lt=_(a),j=f(a,"H3",{id:!0,"data-svelte-h":!0}),v(j)!=="svelte-pazg3s"&&(j.innerHTML=bt),ot=_(a),E(B.$$.fragment,a),st=_(a),E(S.$$.fragment,a),at=_(a),E(O.$$.fragment,a),nt=_(a),E(R.$$.fragment,a),dt=_(a),E(A.$$.fragment,a),it=_(a),U=f(a,"H3",{id:!0,"data-svelte-h":!0}),v(U)!=="svelte-1x7tqpi"&&(U.innerHTML=_t),ct=_(a),E(Y.$$.fragment,a),mt=_(a),E(q.$$.fragment,a),rt=_(a),z=f(a,"H3",{id:!0,"data-svelte-h":!0}),v(z)!=="svelte-1k6pp77"&&(z.innerHTML=gt),ut=_(a),E(G.$$.fragment,a),this.h()},h(){m(d,"class","font-bold"),m(o,"class","alert text-sm"),m(D,"stroke-linecap","round"),m(D,"stroke-linejoin","round"),m(D,"stroke-width","2"),m(D,"d","M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"),m(L,"xmlns","http://www.w3.org/2000/svg"),m(L,"fill","none"),m(L,"viewBox","0 0 24 24"),m(L,"class","stroke-current flex-shrink-0 w-6 h-6"),m(P,"class","alert text-sm mt-4"),m(j,"id","method-1-using-dialog-element-recommended"),m(U,"id","method-2-using-a-hidden-checkbox-legacy"),m(z,"id","method-3-using-anchor-links-legacy")},m(a,h){T(t,a,h),u(a,i,h),u(a,o,h),$(o,e),$(e,d),T(s,d,null),$(e,l),$(e,n),u(a,et,h),u(a,P,h),$(P,L),$(L,D),$(P,pt),$(P,Q),T(F,Q,null),u(a,lt,h),u(a,j,h),u(a,ot,h),T(B,a,h),u(a,st,h),T(S,a,h),u(a,at,h),T(O,a,h),u(a,nt,h),T(R,a,h),u(a,dt,h),T(A,a,h),u(a,it,h),u(a,U,h),u(a,ct,h),T(Y,a,h),u(a,mt,h),T(q,a,h),u(a,rt,h),u(a,z,h),u(a,ut,h),T(G,a,h),ht=!0},p(a,h){const X={};h&5&&(X.$$scope={dirty:h,ctx:a}),B.$set(X);const W={};h&5&&(W.$$scope={dirty:h,ctx:a}),S.$set(W);const K={};h&5&&(K.$$scope={dirty:h,ctx:a}),O.$set(K);const Z={};h&5&&(Z.$$scope={dirty:h,ctx:a}),R.$set(Z);const tt={};h&5&&(tt.$$scope={dirty:h,ctx:a}),A.$set(tt);const vt={};h&5&&(vt.$$scope={dirty:h,ctx:a}),Y.$set(vt);const xt={};h&5&&(xt.$$scope={dirty:h,ctx:a}),q.$set(xt);const kt={};h&5&&(kt.$$scope={dirty:h,ctx:a}),G.$set(kt)},i(a){ht||(N(t.$$.fragment,a),N(s.$$.fragment,a),N(F.$$.fragment,a),N(B.$$.fragment,a),N(S.$$.fragment,a),N(O.$$.fragment,a),N(R.$$.fragment,a),N(A.$$.fragment,a),N(Y.$$.fragment,a),N(q.$$.fragment,a),N(G.$$.fragment,a),ht=!0)},o(a){H(t.$$.fragment,a),H(s.$$.fragment,a),H(F.$$.fragment,a),H(B.$$.fragment,a),H(S.$$.fragment,a),H(O.$$.fragment,a),H(R.$$.fragment,a),H(A.$$.fragment,a),H(Y.$$.fragment,a),H(q.$$.fragment,a),H(G.$$.fragment,a),ht=!1},d(a){a&&(c(i),c(o),c(et),c(P),c(lt),c(j),c(ot),c(st),c(at),c(nt),c(dt),c(it),c(U),c(ct),c(mt),c(rt),c(z),c(ut)),I(t,a),I(s),I(F),I(B,a),I(S,a),I(O,a),I(R,a),I(A,a),I(Y,a),I(q,a),I(G,a)}}}function ae(r){let t,i;const o=[r[1],Tt];let e={$$slots:{default:[se]},$$scope:{ctx:r}};for(let d=0;d<o.length;d+=1)e=ft(e,o[d]);return t=new Dt({props:e}),{c(){M(t.$$.fragment)},l(d){E(t.$$.fragment,d)},m(d,s){T(t,d,s),i=!0},p(d,[s]){const l=s&2?Lt(o,[s&2&&Mt(d[1]),s&0&&Mt(Tt)]):{};s&5&&(l.$$scope={dirty:s,ctx:d}),t.$set(l)},i(d){i||(N(t.$$.fragment,d),i=!0)},o(d){H(t.$$.fragment,d),i=!1},d(d){I(t,d)}}}const Tt={title:"Modal",desc:"Modal is used to show a dialog or a box when you click a button.",published:!0,layout:"components"};function ne(r,t,i){let o;return Ht(r,jt,e=>i(0,o=e)),r.$$set=e=>{i(1,t=ft(ft({},t),yt(e)))},t=yt(t),[o,t]}class ue extends It{constructor(t){super(),Pt(this,t,ne,ae,Nt,{})}}export{ue as component};
