...
</div>`,o,e,d,a;return{c(){t=p("pre"),o=E(i),this.h()},l(l){t=f(l,"PRE",{slot:!0});var n=g(t);o=T(n,i),n.forEach(c),this.h()},h(){m(t,"slot","html")},m(l,n){r(l,t,n),_(t,o),d||(a=H(e=I.call(null,t,{to:u[0]})),d=!0)},p(l,n){e&&N(e.update)&&n&1&&e.update.call(null,{to:l[0]})},d(l){l&&c(t),d=!1,a()}}}function de(u){let t,i,o,e,d,a,l,n,ft,W,_t='<li>Using <code>&lt;dialog&gt;</code> element: It needs JS to open but it has better accessibility and we can close it using <span class="kbd kbd-xs">Esc</span> key</li> <li>Using a hidden <code>&lt;input type=&quot;checkbox&quot;&gt;</code> and <code>&lt;label&gt;</code> to check/uncheck the checkbox and open/close the modal</li> <li>Using <code>&lt;a&gt;</code> anchor links: A link adds a parameter to the URL and you only see the modal when the URL has that parameter</li>',lt,P,L,D,$t,X,F,ot,j,gt='<a aria-hidden="true" tabindex="-1" href="#method-1-using-dialog-element-recommended"><span class="mr-1 opacity-20 hover:opacity-60 text-base font-bold inline-block align-middle relative -mt-1">#</span></a>Method 1: using dialog element <span class="badge badge-success">recommended</span>',st,B,at,S,nt,O,dt,R,it,A,ct,U,vt='<a aria-hidden="true" tabindex="-1" href="#method-2-using-a-hidden-checkbox-legacy"><span class="mr-1 opacity-20 hover:opacity-60 text-base font-bold inline-block align-middle relative -mt-1">#</span></a>Method 2: using a hidden checkbox <span class="badge badge-warning">legacy</span>',mt,G,rt,Y,ut,q,xt='<a aria-hidden="true" tabindex="-1" href="#method-3-using-anchor-links-legacy"><span class="mr-1 opacity-20 hover:opacity-60 text-base font-bold inline-block align-middle relative -mt-1">#</span></a>Method 3: using anchor links <span class="badge badge-warning">legacy</span>',ht,z,pt;return t=new Rt({props:{data:{chrome:37,firefox:98,safari:15.4,iossafari:15.4}}}),o=new Ot({props:{data:[{type:"component",class:"modal",desc:"Container element"},{type:"component",class:"modal-box",desc:"The content of modal"},{type:"component",class:"modal-action",desc:"Container for modal action buttons"},{type:"component",class:"modal-backdrop",desc:"The backdrop that covers the back of modal so we can close the modal by clicking outside"},{type:"component",class:"modal-toggle",desc:"For hidden checkbox that controls modal"},{type:"modifier",class:"modal-open",desc:"Add/remove this class to open/close the modal using JS"},{type:"responsive",class:"modal-top",desc:"Moves the modal to top"},{type:"responsive",class:"modal-bottom",desc:"Moves the modal to bottom"},{type:"responsive",class:"modal-middle",desc:"Moves the modal to middle (default)"}]}}),n=new Ht({props:{text:"There are 3 ways to use a modal:"}}),F=new Ht({props:{text:"Make sure you're using unique IDs for each modal"}}),B=new V({props:{title:"Dialog modal",desc:"opens on click using ID.showModal() method. can be closed using ID.close() method",$$slots:{jsx:[Gt],html:[Ut],default:[At]},$$scope:{ctx:u}}}),S=new V({props:{title:"Dialog modal, closes when clicked outside",desc:"there a second form with 'modal-backdrop' class and it covers the screen so we can close the modal when clicked outside",$$slots:{jsx:[zt],html:[qt],default:[Yt]},$$scope:{ctx:u}}}),O=new V({props:{title:"Dialog modal with a close button at corner",$$slots:{jsx:[Ft],html:[Jt],default:[Vt]},$$scope:{ctx:u}}}),R=new V({props:{title:"Dialog modal with custom width",desc:"You can use any w-* and max-w-* utility class to customize the width",$$slots:{jsx:[Wt],html:[Qt],default:[Kt]},$$scope:{ctx:u}}}),A=new V({props:{title:"Responsive",desc:"Modal goes bottom on mobile screen and goes middle on desktop",$$slots:{jsx:[te],html:[Zt],default:[Xt]},$$scope:{ctx:u}}}),G=new V({props:{title:"Modal using label + hidden checkbox",$$slots:{html:[le],default:[ee]},$$scope:{ctx:u}}}),Y=new V({props:{title:"Modal that closes when clicked outside",desc:"Modal works with a hidden checkbox and labels can toggle the checkbox so we can use another label tag with 'modal-backdrop' class that covers the screen so we can close the modal when clicked outside",$$slots:{html:[se],default:[oe]},$$scope:{ctx:u}}}),z=new V({props:{title:"Modal using anchor link",desc:"Anchor links might not work well on some SPA frameworks so if there are problems, use the first example",$$slots:{html:[ne],default:[ae]},$$scope:{ctx:u}}}),{c(){x(t.$$.fragment),i=$(),x(o.$$.fragment),e=$(),d=p("div"),a=p("div"),l=p("span"),x(n.$$.fragment),ft=$(),W=p("ol"),W.innerHTML=_t,lt=$(),P=p("div"),L=Mt("svg"),D=Mt("path"),$t=$(),X=p("div"),x(F.$$.fragment),ot=$(),j=p("h3"),j.innerHTML=gt,st=$(),x(B.$$.fragment),at=$(),x(S.$$.fragment),nt=$(),x(O.$$.fragment),dt=$(),x(R.$$.fragment),it=$(),x(A.$$.fragment),ct=$(),U=p("h3"),U.innerHTML=vt,mt=$(),x(G.$$.fragment),rt=$(),x(Y.$$.fragment),ut=$(),q=p("h3"),q.innerHTML=xt,ht=$(),x(z.$$.fragment),this.h()},l(s){k(t.$$.fragment,s),i=b(s),k(o.$$.fragment,s),e=b(s),d=f(s,"DIV",{class:!0});var h=g(d);a=f(h,"DIV",{});var K=g(a);l=f(K,"SPAN",{class:!0});var Z=g(l);k(n.$$.fragment,Z),Z.forEach(c),ft=b(K),W=f(K,"OL",{"data-svelte-h":!0}),v(W)!=="svelte-1ii7k10"&&(W.innerHTML=_t),K.forEach(c),h.forEach(c),lt=b(s),P=f(s,"DIV",{class:!0});var Q=g(P);L=Et(Q,"svg",{xmlns:!0,fill:!0,viewBox:!0,class:!0});var tt=g(L);D=Et(tt,"path",{"stroke-linecap":!0,"stroke-linejoin":!0,"stroke-width":!0,d:!0}),g(D).forEach(c),tt.forEach(c),$t=b(Q),X=f(Q,"DIV",{});var et=g(X);k(F.$$.fragment,et),et.forEach(c),Q.forEach(c),ot=b(s),j=f(s,"H3",{id:!0,"data-svelte-h":!0}),v(j)!=="svelte-pazg3s"&&(j.innerHTML=gt),st=b(s),k(B.$$.fragment,s),at=b(s),k(S.$$.fragment,s),nt=b(s),k(O.$$.fragment,s),dt=b(s),k(R.$$.fragment,s),it=b(s),k(A.$$.fragment,s),ct=b(s),U=f(s,"H3",{id:!0,"data-svelte-h":!0}),v(U)!=="svelte-1x7tqpi"&&(U.innerHTML=vt),mt=b(s),k(G.$$.fragment,s),rt=b(s),k(Y.$$.fragment,s),ut=b(s),q=f(s,"H3",{id:!0,"data-svelte-h":!0}),v(q)!=="svelte-1k6pp77"&&(q.innerHTML=xt),ht=b(s),k(z.$$.fragment,s),this.h()},h(){m(l,"class","font-bold"),m(d,"class","alert text-sm"),m(D,"stroke-linecap","round"),m(D,"stroke-linejoin","round"),m(D,"stroke-width","2"),m(D,"d","M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"),m(L,"xmlns","http://www.w3.org/2000/svg"),m(L,"fill","none"),m(L,"viewBox","0 0 24 24"),m(L,"class","stroke-current shrink-0 w-6 h-6"),m(P,"class","alert text-sm mt-4"),m(j,"id","method-1-using-dialog-element-recommended"),m(U,"id","method-2-using-a-hidden-checkbox-legacy"),m(q,"id","method-3-using-anchor-links-legacy")},m(s,h){y(t,s,h),r(s,i,h),y(o,s,h),r(s,e,h),r(s,d,h),_(d,a),_(a,l),y(n,l,null),_(a,ft),_(a,W),r(s,lt,h),r(s,P,h),_(P,L),_(L,D),_(P,$t),_(P,X),y(F,X,null),r(s,ot,h),r(s,j,h),r(s,st,h),y(B,s,h),r(s,at,h),y(S,s,h),r(s,nt,h),y(O,s,h),r(s,dt,h),y(R,s,h),r(s,it,h),y(A,s,h),r(s,ct,h),r(s,U,h),r(s,mt,h),y(G,s,h),r(s,rt,h),y(Y,s,h),r(s,ut,h),r(s,q,h),r(s,ht,h),y(z,s,h),pt=!0},p(s,h){const K={};h&5&&(K.$$scope={dirty:h,ctx:s}),B.$set(K);const Z={};h&5&&(Z.$$scope={dirty:h,ctx:s}),S.$set(Z);const Q={};h&5&&(Q.$$scope={dirty:h,ctx:s}),O.$set(Q);const tt={};h&5&&(tt.$$scope={dirty:h,ctx:s}),R.$set(tt);const et={};h&5&&(et.$$scope={dirty:h,ctx:s}),A.$set(et);const kt={};h&5&&(kt.$$scope={dirty:h,ctx:s}),G.$set(kt);const yt={};h&5&&(yt.$$scope={dirty:h,ctx:s}),Y.$set(yt);const wt={};h&5&&(wt.$$scope={dirty:h,ctx:s}),z.$set(wt)},i(s){pt||(w(t.$$.fragment,s),w(o.$$.fragment,s),w(n.$$.fragment,s),w(F.$$.fragment,s),w(B.$$.fragment,s),w(S.$$.fragment,s),w(O.$$.fragment,s),w(R.$$.fragment,s),w(A.$$.fragment,s),w(G.$$.fragment,s),w(Y.$$.fragment,s),w(z.$$.fragment,s),pt=!0)},o(s){C(t.$$.fragment,s),C(o.$$.fragment,s),C(n.$$.fragment,s),C(F.$$.fragment,s),C(B.$$.fragment,s),C(S.$$.fragment,s),C(O.$$.fragment,s),C(R.$$.fragment,s),C(A.$$.fragment,s),C(G.$$.fragment,s),C(Y.$$.fragment,s),C(z.$$.fragment,s),pt=!1},d(s){s&&(c(i),c(e),c(d),c(lt),c(P),c(ot),c(j),c(st),c(at),c(nt),c(dt),c(it),c(ct),c(U),c(mt),c(rt),c(ut),c(q),c(ht)),M(t,s),M(o,s),M(n),M(F),M(B,s),M(S,s),M(O,s),M(R,s),M(A,s),M(G,s),M(Y,s),M(z,s)}}}function ie(u){let t,i;const o=[u[1],Nt];let e={$$slots:{default:[de]},$$scope:{ctx:u}};for(let d=0;d<o.length;d+=1)e=bt(e,o[d]);return t=new Bt({props:e}),{c(){x(t.$$.fragment)},l(d){k(t.$$.fragment,d)},m(d,a){y(t,d,a),i=!0},p(d,[a]){const l=a&2?jt(o,[a&2&&Tt(d[1]),a&0&&Tt(Nt)]):{};a&5&&(l.$$scope={dirty:a,ctx:d}),t.$set(l)},i(d){i||(w(t.$$.fragment,d),i=!0)},o(d){C(t.$$.fragment,d),i=!1},d(d){M(t,d)}}}const Nt={title:"Modal",desc:"Modal is used to show a dialog or a box when you click a button.",published:!0,layout:"components"};function ce(u,t,i){let o;return Pt(u,St,e=>i(0,o=e)),u.$$set=e=>{i(1,t=bt(bt({},t),Ct(e)))},t=Ct(t),[o,t]}class _e extends Lt{constructor(t){super(),Dt(this,t,ce,ie,It,{})}}export{_e as component};
