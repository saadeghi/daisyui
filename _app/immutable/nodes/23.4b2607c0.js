import{s as de,N as te,z as ce,S as se,a as b,f as h,H as pe,K as re,c as $,g as f,A as P,h as g,F as ue,d,L as ne,j as u,i as m,x as M,y as X,l as G,m as Q,X as U,E as W}from"../chunks/scheduler.cc1ce551.js";import{S as me,i as he,b as H,d as E,m as C,a as D,t as L,e as N}from"../chunks/index.ffedd617.js";import{g as fe,a as oe}from"../chunks/spread.8a54911c.js";import{M as we,p as ve,C as be,a as K,r as Z}from"../chunks/ClassTable.2fcba041.js";import{T as $e}from"../chunks/Translate.1fd63f20.js";function ge(p){let e,n='<input id="my-drawer" type="checkbox" class="drawer-toggle"/> <div class="flex flex-col items-center justify-center drawer-content"><label for="my-drawer" class="btn btn-primary drawer-button">Open drawer</label></div> <div class="drawer-side h-full absolute"><label for="my-drawer" class="drawer-overlay"></label> <ul class="menu p-4 w-60 md:w-80 min-h-full bg-base-200 text-base-content"><li><a>Sidebar Item 1</a></li> <li><a>Sidebar Item 2</a></li></ul></div>';return{c(){e=h("div"),e.innerHTML=n,this.h()},l(a){e=f(a,"DIV",{class:!0,"data-svelte-h":!0}),P(e)!=="svelte-awdj8m"&&(e.innerHTML=n),this.h()},h(){u(e,"class","drawer h-56 rounded overflow-hidden")},m(a,s){m(a,e,s)},p:X,d(a){a&&d(e)}}}function _e(p){let e,n=`<div class="$$drawer">
