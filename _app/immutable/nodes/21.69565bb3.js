...
</div>`,e,i,c,n;return{c(){t=v("pre"),e=j(l),this.h()},l(a){t=u(a,"PRE",{slot:!0});var o=M(t);e=D(o,l),o.forEach(r),this.h()},h(){$(t,"slot","html")},m(a,o){b(a,t,o),E(t,e),c||(n=A(i=L.call(null,t,{to:d[0]})),c=!0)},p(a,o){i&&H(i.update)&&o&1&&i.update.call(null,{to:a[0]})},d(a){a&&r(t),c=!1,n()}}}function rt(d){let t,l,e,i,c,n,a,o,m,O,p,W;return t=new tt({props:{data:[{type:"component",class:"chat",desc:"Container for one line of conversation and all its data"},{type:"modifier",class:"chat-start",desc:"Aligns `chat` to left (required)"},{type:"modifier",class:"chat-end",desc:"Aligns `chat` to end (required)"},{type:"component",class:"chat-image",desc:"For the author image"},{type:"component",class:"chat-header",desc:"For the line above the chat bubble"},{type:"component",class:"chat-footer",desc:"For the line below the chat bubble"},{type:"component",class:"chat-bubble",desc:"For the content of chat"},{type:"modifier",class:"chat-bubble-primary",desc:"sets `primary` color for the `chat-bubble`"},{type:"modifier",class:"chat-bubble-secondary",desc:"sets `secondary` color for the `chat-bubble`"},{type:"modifier",class:"chat-bubble-accent",desc:"sets `accent` color for the `chat-bubble`"},{type:"modifier",class:"chat-bubble-info",desc:"sets `info` color for the `chat-bubble`"},{type:"modifier",class:"chat-bubble-success",desc:"sets `success` color for the `chat-bubble`"},{type:"modifier",class:"chat-bubble-warning",desc:"sets `warning` color for the `chat-bubble`"},{type:"modifier",class:"chat-bubble-error",desc:"sets `error` color for the `chat-bubble`"}]}}),e=new T({props:{title:"chat-start and chat-end",$$slots:{html:[at],default:[et]},$$scope:{ctx:d}}}),c=new T({props:{title:"Chat with image",$$slots:{html:[it],default:[st]},$$scope:{ctx:d}}}),a=new T({props:{title:"Chat with image, header and footer",$$slots:{html:[lt],default:[ct]},$$scope:{ctx:d}}}),m=new T({props:{title:"Chat with header and footer",$$slots:{html:[dt],default:[ot]},$$scope:{ctx:d}}}),p=new T({props:{title:"Chat Bubble with colors",$$slots:{html:[ht],default:[nt]},$$scope:{ctx:d}}}),{c(){f(t.$$.fragment),l=x(),f(e.$$.fragment),i=x(),f(c.$$.fragment),n=x(),f(a.$$.fragment),o=x(),f(m.$$.fragment),O=x(),f(p.$$.fragment)},l(s){g(t.$$.fragment,s),l=S(s),g(e.$$.fragment,s),i=S(s),g(c.$$.fragment,s),n=S(s),g(a.$$.fragment,s),o=S(s),g(m.$$.fragment,s),O=S(s),g(p.$$.fragment,s)},m(s,h){_(t,s,h),b(s,l,h),_(e,s,h),b(s,i,h),_(c,s,h),b(s,n,h),_(a,s,h),b(s,o,h),_(m,s,h),b(s,O,h),_(p,s,h),W=!0},p(s,h){const Y={};h&5&&(Y.$$scope={dirty:h,ctx:s}),e.$set(Y);const F={};h&5&&(F.$$scope={dirty:h,ctx:s}),c.$set(F);const K={};h&5&&(K.$$scope={dirty:h,ctx:s}),a.$set(K);const R={};h&5&&(R.$$scope={dirty:h,ctx:s}),m.$set(R);const V={};h&5&&(V.$$scope={dirty:h,ctx:s}),p.$set(V)},i(s){W||(w(t.$$.fragment,s),w(e.$$.fragment,s),w(c.$$.fragment,s),w(a.$$.fragment,s),w(m.$$.fragment,s),w(p.$$.fragment,s),W=!0)},o(s){y(t.$$.fragment,s),y(e.$$.fragment,s),y(c.$$.fragment,s),y(a.$$.fragment,s),y(m.$$.fragment,s),y(p.$$.fragment,s),W=!1},d(s){s&&(r(l),r(i),r(n),r(o),r(O)),C(t,s),C(e,s),C(c,s),C(a,s),C(m,s),C(p,s)}}}function bt(d){let t,l;const e=[d[1],N];let i={$$slots:{default:[rt]},$$scope:{ctx:d}};for(let c=0;c<e.length;c+=1)i=P(i,e[c]);return t=new X({props:i}),{c(){f(t.$$.fragment)},l(c){g(t.$$.fragment,c)},m(c,n){_(t,c,n),l=!0},p(c,[n]){const a=n&2?Q(e,[n&2&&J(c[1]),n&0&&J(N)]):{};n&5&&(a.$$scope={dirty:n,ctx:c}),t.$set(a)},i(c){l||(w(t.$$.fragment,c),l=!0)},o(c){y(t.$$.fragment,c),l=!1},d(c){C(t,c)}}}const N={title:"Chat bubble",desc:"Chat bubbles are used to show one line of conversation and all its data, including the author image, author name, time, etc.",published:!0,layout:"components"};function vt(d,t,l){let e;return B(d,Z,i=>l(0,e=i)),d.$$set=i=>{l(1,t=P(P({},t),q(i)))},t=q(t),[e,t]}class ft extends U{constructor(t){super(),G(this,t,vt,bt,z,{})}}export{ft as component};
